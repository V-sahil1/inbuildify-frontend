...
export default function EmailDetail() {
  const [emailSide, setEmailSide] = useState<boolean>(false);
        ...
        <div className="container-fluid">
          <div className="flex items-center justify-between gap-2 md:mb-6 mb-4">
            <div className="flex items-center md:gap-2 gap-4">
              <button
                title="Archive"
                className="md:p-2 flex items-center justify-center gap-2"
              >
              ...
              <button className="md:p-2 flex items-center justify-center gap-2">
                ...
                <span className="md:block hidden">Add to task</span>
              </button>
              <button className="md:p-2 flex items-center justify-center gap-2">
                <IconCircleArrowRight className="w-[20px] h-[20px]" />
                <span className="md:block hidden">Move to</span>
              </button>
              <button className="md:p-2 flex items-center justify-center gap-2">
                <IconTags className="w-[20px] h-[20px]" />
                <span className="md:block hidden">Labels</span>
              </button>
          ...
          <div className="card bg-card-color rounded-xl overflow-hidden border border-dashed border-border-color">
            ...
            <div className="py-4 md:px-6 px-4 bg-body-color flex gap-4">
              <Image
                ...
                width="36"
                height="36"
                className="w-[36px] h-[36px] min-w-[36px] rounded-full mt-2"
              />
                    ...
                    <div className="bg-card-color text-font-color rounded-xl overflow-auto max-h-[300px] custom-scrollbar w-[210px] shadow-shadow-lg absolute -left-30 rtl:-right-30 top-full origin-top-left rtl:origin-top-right z-[1] opacity-0 invisible scale-0 transition-all duration-300 group-hover:opacity-100 group-hover:visible group-hover:scale-100">
                      <div className="p-4 flex flex-col gap-2">
                        <div className="flex gap-2 text-[14px]/[20px]">
                          <span className="inline-block min-w-fit">from :</span>
                          <div>
                            <p className="text-font-color-100">Info-TM</p>
                            <Link
                              href="#"
                              className="text-primary transition-all hover:text-secondary"
                            >
                        ...
                        <div className="flex gap-2 text-[14px]/[20px]">
                          <span className="inline-block min-w-fit">to :</span>
                          <div>
                            <p className="text-font-color-100">Chris Fox</p>
                            <Link
                              href="#"
                              className="text-primary transition-all hover:text-secondary"
                            >
                        ...
                        <div className="flex gap-2 text-[14px]/[20px]">
                          <span className="inline-block min-w-fit">cc :</span>
                          <div>
                            <p className="text-font-color-100">Chris Fox</p>
                            <Link
                              href="#"
                        ...
                        <div className="flex gap-2 text-[14px]/[20px]">
                          <span className="inline-block min-w-fit">date :</span>
                          <div>
              ...
              <div className="flex items-center gap-4">
                <p className="md:block hidden">Jul 29, 2019, 4:37 PM</p>
            ...
            <div className="md:p-6 p-4">
              <div className="pb-4 mb-4 border-b border-border-color ">
                ...
                <br />
                <p>
                  I am project outsourcer if need any type of project (website /
                  apps any IT Project ) please read.
                </p>
                <br />
                <p className="mb-4">
                  I am a BDM (Expert in Lead Generation) and I have 11 years of
                  experience in this industry and do the work of outsourcing the
                  project. I am searching an urgent basis expert developer team
                  or company. I have a regular customer, agency, and consultant
                  overseas like USA, Canada, UK etc. Which gives me regular
                  work. There is a lot of projects. They discuss me with every
                  kind of project. I have done a lot of projects with them. And
                  have maintained their relationship. So I have no shortage of
                  any kind of project.
                </p>
                <p className="mb-4">
                  <strong>I will provide 3 Type of service.</strong>
                </p>
                <ul className="mb-4 list-disc ps-4">
                  <li>
                    Direct Project (Outsourcing) Business $5000 minimum in 45
                    working days.
                  </li>
                  <li>Lead Provide (Domestic and International)</li>
                  <li>
                    If you need Bidder so working your profile (25 Bidding
                    Portal)
                  </li>
                </ul>
                <p className="text-info">
                  Purchase: LUNO has not yet purchased this item from you.
                </p>
                <br />
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                <Link
                  href="#"
                  className="py-2 px-4 rounded-md flex items-center gap-4 border border-border-color transition-all hover:border-primary"
                >
