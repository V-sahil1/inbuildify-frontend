...
const AssignSupervisorDropdown = ({ onAssign, assignedSupervisor }) => {
  ...
  const dropdownContent = (
    <div
      className="w-64 bg-white rounded-md shadow-md p-2"
        ...
        <List
          ...
          renderItem={(option) => (
            <div
              ...
              className={`px-3 py-2 rounded cursor-pointer hover:bg-gray-100 ${assignedSupervisor === option.label ? "bg-gray-200 font-semibold" : ""
                }`}
            >
              {option.label}
            </div>
