...
import { IconChevronRight, IconDots, IconX } from "@tabler/icons-react";
import Link from "next/link";
import Image from "next/image";

export default function Bookmark() {
  const [createBookmarkModal, setCreateBookmarkModal] =
    useState<boolean>(false);
  const openCreateBookmarkModal = () => {
    setCreateBookmarkModal(!createBookmarkModal);
  };
  useEffect(() => {
    document.body.classList[createBookmarkModal ? "add" : "remove"](
      "overflow-hidden"
    );
  }, [createBookmarkModal]);
        ...
        <Tabs>
          <div className="card bg-card-color rounded-xl grid xxl:grid-cols-[1fr_3fr] lg:grid-cols-[1.5fr_3fr] grid-cols-1 border border-dashed border-border-color">
            <TabList className="lg:border-r lg:border-b-0 border-b border-border-color">
              <div className="md:p-6 p-4 border-b border-border-color">
                <Image
                  ...
                  height="90"
                  alt="user profile"
                  className="w-[90px] h-[90px] min-w-[90px] p-1 border border-border-color rounded-full"
                ></Image>
              ...
              <div className="md:p-6 p-4 border-b border-border-color">
                <p className="mb-4">Bookmark List</p>
                <Tab
                  className="flex items-center gap-2 cursor-pointer py-2 md:px-4 px-3 md:text-base text-[14px]/[16px] text-primary rounded-md transition-all hover:bg-primary-10 focus:outline-0"
              ...
              <div className="md:p-6 p-4">
                <p className="md:mb-4 mb-2">Bookmark Tags</p>
            ...
            <div className="md:p-6 p-4">
                ...
                <ul className="mt-4 flex flex-col gap-1">
                  <li className="flex md:items-start md:flex-nowrap flex-wrap md:justify-normal justify-between md:gap-6 gap-4 rounded-xl p-4 border border-dashed border-border-color">
                    <Image
                      ...
                      width="120"
                      height="75"
                      className="w-[120px] h-[75px] object-cover rounded-md self-center"
                    />
                    <div className="md:order-2 order-3 flex-grow">
                      ...
                      <Link
                        href="#"
                        className="inline-block text-primary mb-1 transition-all hover:text-secondary"
                      >
                  ...
                  <li className="flex md:items-start md:flex-nowrap flex-wrap md:justify-normal justify-between md:gap-6 gap-4 rounded-xl p-4 border border-dashed border-border-color">
                    ...
                    <div className="md:order-2 order-3 flex-grow">
                      ...
                      <p className="text-font-color-100">
                        I have been a Personal trainer for 2 years building a
                        women's fitness company Bootcamp company in 2018.
                      </p>
                    </div>
                    <button className="bg-primary-10 p-[2px] rounded-full text-primary self-start md:order-3 order-2 transition-all hover:bg-primary hover:text-white">
                      <IconDots className="w-[18px] h-[18px]" />
              ...
              <TabPanel>
                <h5 className="text-[20px]/[24px] font-medium">Favourites</h5>
                <ul className="mt-4 flex flex-col gap-1">
                  <li className="flex md:items-start md:flex-nowrap flex-wrap md:justify-normal justify-between md:gap-6 gap-4 rounded-xl p-4 border border-dashed border-border-color">
                    <Image
                      src={gallery2}
              ...
              <TabPanel>
                <h5 className="text-[20px]/[24px] font-medium">My bookmark</h5>
                <ul className="mt-4 flex flex-col gap-1">
                  <li className="flex md:items-start md:flex-nowrap flex-wrap md:justify-normal justify-between md:gap-6 gap-4 rounded-xl p-4 border border-dashed border-border-color">
                    <Image
                      src={gallery3}
                  ...
                  <div className="my-10 lg:px-20 md:px-10 px-[7px] md:max-h-[80svh] max-h-[60svh] overflow-auto custom-scrollbar">
                    <div className="form grid grid-cols-1 gap-2">
                      <div className="floating-form-control">
                        ...
                        />
                        <label htmlFor="bookmarkUrl" className="form-label">
                          Bookmark Url
                        </label>
                      </div>
                      <div className="floating-form-control">
                        ...
                        />
                        <label htmlFor="bookmarkTitle" className="form-label">
                          Bookmark Title
                        </label>
                      </div>
                      <div className="floating-form-control">
