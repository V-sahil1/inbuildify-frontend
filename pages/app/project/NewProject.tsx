        ...
        <div className="md:h-[calc(100svh-63px)] h-[calc(100svh-55px)] overflow-auto custom-scrollbar">
          <Tabs>
            <TabList className="flex flex-wrap items-center md:px-6 px-4 pt-4">
              <Tab
                className="flex-1 py-2 px-4 min-w-fit text-center cursor-pointer border-b-4 border-transparent -mb-1 focus:outline-0"
            ...
            <div className="md:p-6 p-4">
              ...
              <TabPanel>
                ...
                <div className="floating-form-control mb-4">
                  ...
                  />
                  <label htmlFor="inviteTeam" className="form-label">
                    Invite Teammates
                  </label>
                </div>
              ...
              <TabPanel>
                <h6 className="font-semibold mb-1">Upload Files</h6>
                ...
                <ul className="md:-mx-6 -mx-4 mb-6">
                  <li className="border-b border-dashed border-border-color md:px-6 p-4 flex items-center gap-3 cursor-pointer transition-all hover:bg-primary-10 last:border-b-0">
                    ...
                    <div className="truncate">
                      <p className="truncate">Annual Sales Report 2018-19</p>
                      <p className="text-[14px]/[20px] text-font-color-100 truncate">
                        .pdf, 5.3 MB
                      </p>
                    </div>
                  ...
                  <li className="border-b border-dashed border-border-color md:px-6 p-4 flex items-center gap-3 cursor-pointer transition-all hover:bg-primary-10 last:border-b-0">
                    ...
                    <div className="truncate">
                      <p className="truncate">Complete Product Sheet</p>
                      <p className="text-[14px]/[20px] text-font-color-100 truncate">
                        .xls, 2.1 MB
                      </p>
                    </div>
                  ...
                  <li className="border-b border-dashed border-border-color md:px-6 p-4 flex items-center gap-3 cursor-pointer transition-all hover:bg-primary-10 last:border-b-0">
                    ...
                    <div className="truncate">
                      <p className="truncate">Marketing Guidelines</p>
                      <p className="text-[14px]/[20px] text-font-color-100 truncate">
                        .doc, 2.3 MB
                      </p>
                    </div>
                  ...
                  <li className="border-b border-dashed border-border-color md:px-6 p-4 flex items-center gap-3 cursor-pointer transition-all hover:bg-primary-10 last:border-b-0">
                    ...
                    <div className="truncate">
                      <p className="truncate">Brand Photography</p>
                      <p className="text-[14px]/[20px] text-font-color-100 truncate">
                        .zip, 30.5 MB
                      </p>
                    </div>
