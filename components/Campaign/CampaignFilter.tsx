...
export default function CampaignFilter() {
    ...
    const filterCheckBoxData = [
        ...
        { title: 'Job Status', options: ['In Progress', 'Cancelled', 'Archived', 'Completed', 'On Hold'] },
        { title: 'Construction', options: ['Ready for Construction', 'Under Construction', 'Completed', 'On Hold'] },
        ...
        <>
            <div>
                <div className="flex justify-between mb-3 text-sm">
                    <div><Checkbox /> Leads/jobs</div>
                    <div><Checkbox /> Import Contacts <p className="text-blue">import more</p></div>
                    <div><Checkbox /> Campaign Contacts</div>
                    <div><Checkbox /> Groups</div>
                    <div><Checkbox /> Referral Partners</div>
                    <div><Checkbox /> Supplier/Trades</div>
                </div>
                    ...
                    <div className="flex justify-between text-sm">
                        ...
                        <div>
                            ...
                            <div className="flex flex-col gap-3">
                                <div><Radio.Group options={[{ value: 'contact', label: 'Contact' }, { value: 'property', label: 'Property' }]}></Radio.Group></div>
                                <Select size="small" placeholder='Suburb/ City'></Select>
                                <Input size="small" placeholder="search" value={address}
                                    onChange={(e) =>
