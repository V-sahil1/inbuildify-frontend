...
export default function FileManager() {
  const [fileManagerSide, setFileManagerSide] = useState<boolean>(false);
  const socialSideToggle = () => {
    setFileManagerSide(!fileManagerSide);
  };

  const [analyticsSidebar, setAnalyticsSidebar] = useState<boolean>(false);
   ...
   fileManagerSide
     ...
     : "-left-full rtl:-right-full"
        ...
        >
          ...
          <TabList>
            <Tab
              className="flex items-center gap-4 font-semibold py-2 cursor-pointer hover:text-primary focus:outline-0"
              selectedClassName="text-primary"
            >
              <IconServer2 className="w-[20px] h-[20px]" />
              <span className="flex-1 inline-block">My Drive</span>
            ...
            >
              ...
              <span className="flex-1 inline-block">Recent</span>
              <span className="inline-block bg-body-color rounded-md py-1 px-2 text-[12px]/[1] text-font-color font-semibold">
                2
              </span>
            </Tab>
          ...
          <button
            ...
            className="flex items-center gap-4 font-semibold py-2 cursor-pointer transition-all duration-300 hover:text-primary"
          >
          ...
          <ul className="flex flex-col gap-4">
            <li>
              ...
              >
                ...
                <span className="flex-1 inline-block">Documents</span>
              </Link>
            </li>
            <li>
              <Link
              ...
              >
                <IconTag className="w-[18px] h-[18px]" />
                <span className="flex-1 inline-block">Work Project</span>
              </Link>
            </li>
            <li>
              <Link
              ...
              >
                <IconTag className="w-[18px] h-[18px]" />
                <span className="flex-1 inline-block">Templates</span>
              </Link>
            </li>
          </ul>
          <p className="py-4 mt-4 border-t border-border-color uppercase text-font-color-100 text-[14px]/[20px]">
      ...
      >
        <div className="md:px-6 px-4 md:py-4 py-3 flex items-center justify-between gap-15 border-b border-border-color">
          <div className="text-[20px]/[30px] font-medium">Drive Analytics</div>
