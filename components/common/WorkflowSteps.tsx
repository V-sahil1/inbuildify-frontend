                ...
                return (
                    ...
                    <div className="flex flex-1 " onClick={(e) => {e.preventDefault(); item?.onClick()}}>
                        <div className={`flex-1 flex-col text-center py-2  cursor-pointer  justify-center ${item.color}
                            ...
                            <div className={`md:pr-[40px] md:pl-[20px]  ${index == 0 ? "pr-[20px]" : isLast ? "pl-[25px]" : " sm:px-[26px] px-[32px]"}`}>
                                <div className="flex justify-center">
                                    <div className={`flex items-center justify-center border-[2px] border-white rounded-full w-30 h-30 ${item.color} text-white my-2 p-2 text-xs`}>{item.icon}</div>
                                </div>
