...
const FloorPlan = () => {
  ...
  const handleEdit = (floorPlan: IFloorPlanState) => {
    ...
    const mappedFloorPlan = {
      ...
      beds: floorPlan.beds,
      bath: floorPlan.baths,
      car_park: floorPlan.carpark,
      width_meter: floorPlan.minLandWidth,
      depth_meter: floorPlan.minLandDepth,
      dwelling: floorPlan.dwellingTypeId,
      garage: floorPlan.garageArea,
      porch: floorPlan.porchArea,
      alfresco: floorPlan.alfrescoArea,
      total_sqft: floorPlan.totalArea,
    };
