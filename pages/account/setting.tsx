...
export default function Setting() {
  ...
  const handleFileChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      reader.onloadend = () => {
        setEditUser(reader.result as string);
      };
        ...
        <div className="grid lg:grid-cols-[1fr_2.5fr] grid-cols-1 gap-6 items-start">
          ...
          <div className="flex flex-col md:gap-12 gap-6">
            <div
              ...
              className="relative rounded-xl border border-dashed border-border-color p-4"
            >
                ...
                <div className="md:p-6 p-4 flex flex-col gap-4">
                  ...
                  <div className="grid sm:grid-cols-[1fr_3fr] grid-cols-1 gap-2">
                    ...
                    <div className="form-control">
                      <input
                        type="text"
                        className="form-input"
                        placeholder="swtift pro"
                        defaultValue="swtift pro"
                      />
                    </div>
                  </div>
                  <div className="grid sm:grid-cols-[1fr_3fr] grid-cols-1 gap-2">
                  ...
                  <div className="grid sm:grid-cols-[1fr_3fr] grid-cols-1 gap-2">
                    ...
                    <div className="form-control">
                      <input
                        type="text"
                        className="form-input"
                        placeholder="www.swtiftpro.com"
                        defaultValue="www.swtiftpro.com"
                      />
                    </div>
                  </div>
                  <div className="grid sm:grid-cols-[1fr_3fr] grid-cols-1 gap-2">
                  ...
                  <div className="grid sm:grid-cols-[1fr_3fr] grid-cols-1 gap-2">
                    ...
                    <div className="form-check form-switch">
                      <input
                        type="checkbox"
                        id="accountSettingAvail"
                        className="form-check-input"
                      />
                      <label
                        htmlFor="accountSettingAvail"
                        className="form-check-label !text-[16px]/[24px]"
                      >
                        Yes, advertise my availability on my profile page
                      </label>
                    </div>
                  </div>
                </div>
                ...
                <div className="md:p-6 p-4">
                  <div className="grid md:grid-cols-3 grid-cols-1 md:gap-4 gap-2">
                    ...
                    <div className="form-control">
                      <input
                        type="text"
                        className="form-input"
                        placeholder="louis.info@yourdomain.com"
                  ...
                  <div className="md:mt-6 mt-4 border-t border-border-color">
                    ...
                    <div className="form-control">
                      ...
                      />
                      <span className="text-font-color-100 small">
                        ...
                        <tr className="border-b border-dashed border-border-color last:border-b-0">
                          ...
                          <td className="py-3 px-4 border-e border-dashed border-border-color last:border-e-0">
                            <div className="form-check">
                              <input
                                type="checkbox"
                                id="emailNotiSettingEmail"
                                className="form-check-input"
                                defaultChecked
                              />
                              <label
                                htmlFor="emailNotiSettingEmail"
                                className="form-check-label !text-[16px]/[24px]"
                              >
                                Email
                              </label>
                          ...
                          <td className="py-3 px-4 border-e border-dashed border-border-color last:border-e-0">
                            <div className="form-check">
                              <input
                                type="checkbox"
                                id="emailNotiSettingPhone"
                                className="form-check-input"
                                defaultChecked
                              />
                              <label
                                htmlFor="emailNotiSettingPhone"
                                className="form-check-label !text-[16px]/[24px]"
                              >
                                Phone
                              </label>
                        ...
                        <tr className="border-b border-dashed border-border-color last:border-b-0">
                          ...
                          <td className="py-3 px-4 border-e border-dashed border-border-color last:border-e-0">
                            <div className="form-check">
                              <input
                                type="checkbox"
                                id="billNotiSettingEmail"
                                className="form-check-input"
                              />
                              <label
                                htmlFor="billNotiSettingEmail"
                                className="form-check-label !text-[16px]/[24px]"
                              >
                                Email
                              </label>
                          ...
                          <td className="py-3 px-4 border-e border-dashed border-border-color last:border-e-0">
                            <div className="form-check">
                              <input
                                type="checkbox"
                                id="billNotiSettingPhone"
                                className="form-check-input"
                              />
                              <label
                                htmlFor="billNotiSettingPhone"
                                className="form-check-label !text-[16px]/[24px]"
                              >
                                Phone
                              </label>
                        ...
                        <tr className="border-b border-dashed border-border-color last:border-b-0">
                          ...
                          <td className="py-3 px-4 border-e border-dashed border-border-color last:border-e-0">
                            <div className="form-check">
                              <input
                                type="checkbox"
                                id="newMemberNotiSettingEmail"
                                className="form-check-input"
                              />
                              <label
                                htmlFor="newMemberNotiSettingEmail"
                                className="form-check-label !text-[16px]/[24px]"
                              >
                                Email
                              </label>
                          ...
                          <td className="py-3 px-4 border-e border-dashed border-border-color last:border-e-0">
                            <div className="form-check">
                              <input
                                type="checkbox"
                                id="newMemberNotiSettingPhone"
                                className="form-check-input"
                              />
                              <label
                                htmlFor="newMemberNotiSettingPhone"
                                className="form-check-label !text-[16px]/[24px]"
                              >
                                Phone
                              </label>
                        ...
                        <tr className="border-b border-dashed border-border-color last:border-b-0">
                          ...
                          <td className="py-3 px-4 border-e border-dashed border-border-color last:border-e-0">
                            <div className="form-check">
                              <input
                                type="checkbox"
                                id="projectNotiSettingEmail"
                                className="form-check-input"
                              />
                              <label
                                htmlFor="projectNotiSettingEmail"
                                className="form-check-label !text-[16px]/[24px]"
                              >
                                Email
                              </label>
                          ...
                          <td className="py-3 px-4 border-e border-dashed border-border-color last:border-e-0">
                            <div className="form-check">
                              <input
                                type="checkbox"
                                id="projectNotiSettingPhone"
                                className="form-check-input"
                                defaultChecked
                              />
                              <label
                                htmlFor="projectNotiSettingPhone"
                                className="form-check-label !text-[16px]/[24px]"
                              >
                                Phone
                              </label>
                        ...
                        <tr className="border-b border-dashed border-border-color last:border-b-0">
                          ...
                          <td className="py-3 px-4 border-e border-dashed border-border-color last:border-e-0">
                            <div className="form-check">
                              <input
                                type="checkbox"
                                id="newsletterNotiSettingEmail"
                                className="form-check-input"
                              />
                              <label
                                htmlFor="newsletterNotiSettingEmail"
                                className="form-check-label !text-[16px]/[24px]"
                              >
                                Email
                              </label>
                          ...
                          <td className="py-3 px-4 border-e border-dashed border-border-color last:border-e-0">
                            <div className="form-check">
                              <input
                                type="checkbox"
                                id="newsletterNotiSettingPhone"
                                className="form-check-input"
                                defaultChecked
                              />
                              <label
                                htmlFor="newsletterNotiSettingPhone"
                                className="form-check-label !text-[16px]/[24px]"
                              >
                                Phone
                              </label>
            ...
            >
              ...
              <div className="card bg-card-color rounded-xl">
                <div className="md:p-6 p-4">
                  <div className="form-control mb-4">
                    <label className="mb-2 inline-block">Twitter</label>
                    <input type="text" className="form-input" />
                    <button className="btn btn-info my-5">
                      <IconBrandTwitterFilled className="w-[16px] h-[16px] min-w-[16px]" />
                      Connect to Twitter
                    </button>
                    <div className="small text-font-color-100">
                      One-click sign in
                    </div>
                  </div>
                  <div className="form-control mb-4">
                    <label className="mb-2 inline-block">Facebook</label>
                    <input type="text" className="form-input" />
                  </div>
                  <div className="form-control mb-4">
                    <label className="mb-2 inline-block">Behance</label>
                    <input type="text" className="form-input" />
                  </div>
                  <div className="form-control mb-4">
                    <label className="mb-2 inline-block">LinkedIn</label>
                    <input type="text" className="form-input" />
                  </div>
                </div>
                <div className="md:p-6 p-4 flex justify-end flex-wrap gap-4 border-t border-dashed border-border-color">
