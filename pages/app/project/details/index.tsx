     ...
     : "-left-full rtl:-right-full"
      ...
      >
        <button
          ...
          className={`bg-secondary py-10 px-15 rounded-md text-[14px]/[20px] large w-full text-white mb-4 transition-all duration-300 after:fixed after:z-[4] after:w-full after:h-full after:left-0 after:top-0 after:bg-black-50 after:backdrop-blur-[2px] after:transition-all after:duration-500 after:ease-in-out ${
            newProjectSidebar
        ...
        <div>
          <p className="text-[32px]/[38px] mb-4">$8,890</p>
          <div className="mb-3">
            <span className="font-bold">22 Feb 2022</span>
            <p className="text-font-color-100 small">Due Date</p>
          </div>
        </div>
        <p className="py-4 mt-4 border-t border-border-color uppercase text-font-color-100 small">
          CLIENTS DETAIL
        ...
        <Image
          ...
          height="90"
          alt="user"
          className="p-1 border border-border-color rounded-full mb-4"
        />
        <p className="font-medium">Michelle Green</p>
        <p className="font-medium">jason-porter@info.com</p>
        <button className="btn btn-outline-secondary mt-4">Message</button>
      </div>
