...
export default function Widget() {
  const [jobListingModal, setJobListingModal] = useState<boolean>(false);
  const openJobListingModal = () => {
    setJobListingModal(!jobListingModal);
  };
  useEffect(() => {
    document.body.classList[jobListingModal ? "add" : "remove"](
      "overflow-hidden"
    );
  }, [jobListingModal]);
    ...
    <div className="md:px-6 sm:px-3 pt-4">
      <div className="container-fluid">
        ...
        <div className="grid lg:grid-cols-3 grid-cols-1 gap-4">
          <div className="flex flex-col gap-4">
            ...
            <div className="card md:p-6 p-4 rounded-xl border border-dashed border-danger text-danger bg-red-100">
              <IconAirConditioning />
              <div className="mt-4">
                <p className="mb-2 font-medium">Air Conditioner</p>
                <div className="flex items-center justify-between gap-15 text-[14px]/[20px]">
                  <span className="inline-block">Temprature :</span>
                  <span className="inline-block font-semibold">26° C</span>
                </div>
                <div className="flex items-center justify-between gap-15 text-[14px]/[20px]">
                  <span className="inline-block">Status :</span>
                  <span className="inline-block font-semibold">Cooling On</span>
                </div>
              </div>
            </div>
            <div className="md:p-6 p-4 rounded-xl card bg-card-color border border-dashed border-border-color">
              ...
              <div className="flex justify-between text-font-color-100 mt-2 text-[14px]/[20px]">
            ...
            <div className="card bg-card-color rounded-xl border border-dashed border-border-color relative xxl:p-12 p-6 flex flex-col">
              ...
              <ul className="flex flex-col gap-2 mb-6 list-disc ps-20">
                ...
                <li>Unlimited Live Dashboards</li>
              </ul>
            ...
            <div className="card bg-card-color p-4 rounded-xl border border-dashed border-border-color">
              ...
              <div className="flex items-end gap-2">
                <span className="font-bold text-[24px]/[30px]">12</span>
            ...
            <div className="flex gap-4 sm:flex-row flex-col-reverse card bg-secondary text-white rounded-xl overflow-hidden md:p-6 p-4 border border-dashed border-border-color">
              <div>
                ...
                <p className="mb-6">1 Jan 20222, 11:15 AMF</p>
                <div className="flex flex-wrap gap-10">
                  <button className="btn btn-white">Published</button>
                  <button
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="card bg-card-color rounded-xl border border-dashed border-border-color overflow-hidden">
              <div className="flex items-center justify-between gap-2 md:p-6 p-4">
                <div className="font-semibold">Notifications Settings</div>
                <button className="bg-primary-10 p-[2px] rounded-full text-primary transition-all hover:bg-primary hover:text-white">
                  <IconDots className="w-[18px] h-[18px]" />
                </button>
              </div>
                ...
                <li className="py-3 px-4 border-b border-dashed last:border-none transition-all hover:bg-primary-10">
                  <div className="form-check">
                    <input
                      type="checkbox"
                      id="notiSetting1"
                      className="form-check-input check-line"
                    />
                    <label
                      className="form-check-label !text-[16px]/[24px]"
                      htmlFor="notiSetting1"
                    >
            ...
            <div className="card rounded-xl bg-card-color md:p-6 p-4 border border-dashed border-border-color">
              <p className="font-semibold md:mb-6 mb-4">Average Agent Rating</p>
            ...
            <div className="card bg-card-color rounded-xl border border-dashed border-border-color md:p-6 p-4">
              ...
              <div className="form-control flex w-full">
                ...
                />
                <button
                  className="btn border border-border-color !rounded-l-none"
                  type="button"
                >
          ...
          <div className="flex flex-col gap-4">
            <div className="card bg-card-color rounded-xl border border-dashed border-border-color overflow-hidden">
              <div className="md:p-6 p-4">
                <p className="uppercase mb-2">GOAL COMPLETIONS</p>
                <p className="text-[24px]/[30px] font-medium mb-1">$1,22,500</p>
            ...
            <div className="card rounded-xl bg-card-color md:p-6 p-4 border border-dashed border-border-color">
              ...
              <div className="flex gap-4 mb-6">
                <Image
                  ...
                  width="56"
                  height="56"
                  className="w-[56px] h-[56px] min-w-[56px] object-cover rounded-md"
                />
                <div>
                  <p className="text-[20px]/[24px] font-medium mb-1">
                    Hossein Shams
                  </p>
                  <p className="text-font-color-100">21 mutual connections</p>
                </div>
              </div>
            ...
            <div className="card bg-card-color rounded-xl border border-dashed border-border-color">
              <div className="md:p-6 p-4 border-b border-dashed border-border-color">
                ...
                <div className="flex items-center flex-wrap gap-1 mb-4">
                  <label className="me-1">Team :</label>
                  <Image
                    src={avatar1}
                    alt="user"
                    width="26"
                    height="26"
                    className="w-[26px] h-[26px] min-w-[26px] rounded-md"
                  />
                  <Image
                    src={avatar2}
                    alt="user"
              ...
              <div className="md:p-6 p-4 flex gap-x-3 gap-y-1 flex-wrap">
                <div className="flex gap-1 flex-wrap">
                  <span className="min-w-fit">Due date :</span>
                  <strong className="min-w-fit">21 Aug, 2022</strong>
                </div>
                <span className="inline-block">|</span>
                <div className="flex gap-1 flex-wrap">
                  <span className="min-w-fit">Budget :</span>
                  <strong className="min-w-fit">$12,050</strong>
                </div>
              </div>
            </div>
            <div className="card rounded-xl bg-card-color md:p-6 p-4 border border-dashed border-border-color">
            ...
            <div className="card overflow-hidden bg-card-color rounded-xl relative border border-dashed border-border-color">
              ...
              <div className="px-6 pb-6 pt-12 text-center relative">
                <Image
                  ...
                  width="120"
                  height="120"
                  className="absolute left-[50%] top-0 translate-x-[-50%] translate-y-[-50%] w-[120px] h-[120px] min-w-[120px] object-cover rounded-full p-1 bg-card-color shadow-shadow-lg"
                />
                <p className="font-medium mt-6">Comeren Diaz</p>
                <p className="text-font-color-100">example@info.com</p>
                <ul className="flex items-stretch justify-center">
                  <li className="flex">
                    <Link
                      href="#"
                      className="p-2 m-2 inline-block text-primary transition-all hover:text-secondary"
                    >
                      <IconBrandFacebook />
                    </Link>
                  </li>
            ...
            <div className="card bg-card-color rounded-xl border border-dashed border-border-color overflow-hidden md:mb-8 mb-6">
              <div className="md:p-6 p-4 bg-secondary text-white">
                <h4 className="text-[24px]/[30px] font-medium mb-2">
                  luno.com
                </h4>
        ...
        {jobListingModal && (
          <>
            <div
              className={`fixed p-15 w-full max-w-[500px] left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] z-[6]`}
            >
              <div className="bg-card-color rounded-lg shadow-shadow-lg overflow-hidden">
                <div className="p-4 flex gap-5 justify-between border-b border-border-color">
                  <p className="text-[20px]/[26px] font-medium">Job listing</p>
                ...
                <div className="py-10 md:px-10 px-[7px] bg-body-color">
                  <div className="my-10 lg:px-20 md:px-10 px-[7px] md:max-h-[80svh] max-h-[60svh] overflow-auto custom-scrollbar">
                    ...
                    <div className="card bg-card-color rounded-xl md:p-6 p-4 mb-2">
                      <span className="small rounded-full text-white py-1 px-4 bg-primary">
                        Creative &amp; Art
                      </span>
                      <h5 className="mt-6 text-[20px]/[24px] font-medium text-primary transition-all hover:text-secondary">
                        <Link href="#">User Experience Designer Employee</Link>
                      </h5>
                    ...
                    <div className="card bg-card-color rounded-xl md:p-6 p-4 mb-2">
                      <span className="small rounded-full text-white py-1 px-4 bg-secondary">
                        UI/UX
                      </span>
                      <h5 className="mt-6 text-[20px]/[24px] font-medium text-primary transition-all hover:text-secondary">
                        <Link href="#">User Experience Designer Employee</Link>
                    ...
                    <div className="card bg-card-color rounded-xl md:p-6 p-4">
                      <span className="small rounded-full text-white py-1 px-4 bg-chart-color3">
                        Finance & Accounting
                      </span>
                      <h5 className="mt-6 text-[20px]/[24px] font-medium text-primary transition-all hover:text-secondary">
                        <Link href="#">Foreign Language Research Analyst</Link>
                      </h5>
                      <ul className="flex flex-wrap gap-x-6 gap-y-1 my-4">
                        <li className="flex items-center gap-2">
                          <IconMapPin className="w-[18px] h-[18px] min-w-[18px]" />{" "}
            ...
            <div
              onClick={openJobListingModal}
              className={`contents-[] fixed z-[5] w-full h-full left-0 top-0 bg-black-50 backdrop-blur-[2px]`}
            ></div>
          </>
        )}
        {campaignsModal && (
          <>
            <div
              className={`fixed p-15 w-full max-w-[800px] left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] z-[6]`}
            >
                ...
                <div className="my-10 lg:px-20 md:px-10 px-[7px] md:max-h-[80svh] max-h-[60svh] overflow-auto custom-scrollbar">
                  ...
                  <div className="grid sm:grid-cols-3 grid-cols-1 gap-10 mb-1">
                    <div className="form-control">
                      <label htmlFor="campaignsDate" className="form-label">
                        Date
                      </label>
                      <input
                        type="date"
                    ...
                    <div className="form-control">
                      <label htmlFor="campaignsTime" className="form-label">
                        Time
                      </label>
                      <input
                        type="time"
                  ...
                  <div className="form-control mb-15">
                    ...
                    <input
                      type="text"
                      id="campaignsLocation"
                      placeholder="Location"
                      className="form-input"
                    />
                  </div>
                  <div className="form-control mb-15 flex gap-2 items-center">
                    <label className="form-label">Participate :</label>
                    <Link href="#">
                      <Image
                        src={avatar1}
                        width="26"
