        ...
        <div className="container-fluid">
          ...
          <div className="card bg-card-color rounded-xl md:p-6 p-4">
            <div className="flex items-center gap-10 mb-30">
              <IconDiamondFilled />
              <p className="text-[20px]/[24px] font-medium">References</p>
            </div>
              ...
              <table className="w-full min-w-[374px] table-striped text-[16px]/[24px]">
                <tbody>
                  <tr>
                    ...
                    <td className="p-3 border-t border-border">
                      <Link
                        ...
                        target="_blank"
                        className="text-blue transition-all duration-300 hover:text-primary"
                      >
                  ...
                  <tr>
                    ...
                    <td className="p-3 border-t border-border">
                      <Link
                        href="https://react-data-table-component.netlify.app/?path=/docs/getting-started-intro--docs"
                        target="_blank"
                        className="text-blue transition-all duration-300 hover:text-primary"
                      >
