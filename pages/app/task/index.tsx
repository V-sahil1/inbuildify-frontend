...
export default function Task() {
  const [taskSide, setTaskSide] = useState<boolean>(false);
     ...
     : "-left-full rtl:-right-full"
        ...
        >
          <button
            ...
            className="btn bg-secondary large w-full text-white mb-4"
          >
            New Task
          </button>
          <TabList>
          ...
          <ul className="flex flex-col gap-4">
            ...
            <li>
              ...
              >
                <IconTag className="w-[18px] h-[18px]" />
                <span className="flex-1 inline-block">BugFix</span>
              </Link>
            </li>
            <li>
              <Link
              ...
              >
                <IconTag className="w-[18px] h-[18px]" />
                <span className="flex-1 inline-block">Help</span>
              </Link>
            </li>
            <li>
              <Link
              ...
              >
                <IconTag className="w-[18px] h-[18px]" />
                <span className="flex-1 inline-block">R&D</span>
              </Link>
            </li>
          </ul>
        </div>
          ...
          >
            <div className="bg-card-color rounded-lg shadow-shadow-lg">
              <div className="p-4 flex gap-5 justify-between border-b border-border-color">
                <p className="text-[20px]/[26px] font-medium">Add Task</p>
