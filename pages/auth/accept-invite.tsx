...
export default function AcceptInvite() {
  ...
  return (
    <>
      ...
      <Form form={form} layout="vertical" onFinish={onFinish} className="form-control">
        <Form.Item label="Full Name" name="name" className="form-control mb-15" rules={nameRules}>
