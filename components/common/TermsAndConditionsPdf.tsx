          ...
          <View style={{ marginLeft: 10, marginRight: 30 }}>
            ...
            <View style={styles.secondaryText}>
              ...
              <Text>
                ...
                sales consultant; the preparation of your quotation, siting and associated
                documents; and all other necessary works to prepare your paperwork for the Tender
                Stage.
              </Text>
            </View>
            <View style={styles.secondaryText}>
              ...
              <Text>
                ...
                Quotation and which causes an increase in the cost to the Builder in constructing
                your home.
              </Text>
            </View>
            <View style={styles.secondaryText}>
              <Text style={{ marginHorizontal: 5 }}>-</Text>
              <Text>
                My Home will conduct a preliminary bushfire assessment at the time of the site
                survey. The costs associated with any additional works resulting from the Client’s
                land being in a bushfire-prone area will be borne by the Client.
              </Text>
            </View>
            <View style={styles.secondaryText}>
              <Text style={{ marginHorizontal: 5 }}>-</Text>
              <Text>
                The pricing and quantities contained in this Sales Quotation are approximates only
                and subject to adjustment, and Builder is not bound by the estimated pricing and/or
                any representation set out in this Sales Quotation. The pricing will be confirmed at
            ...
            <View style={styles.secondaryText}>
              <Text style={{ marginHorizontal: 5 }}>-</Text>
              <Text>
                This Sales Quotation is accepted by the Client once the Sales Quotation is signed
                and the initial deposit paid.
              </Text>
            </View>
          </View>
        </View>
