...
export default function Land() {
    ...
    const columns: ColumnsType<DataType> = [
            ...
            title: (
                <div>
                    ...
                    <Input
                        ...
                        onChange={(e) =>
                            handleFilterChange({ ...filters, lotNumber: e.target.value })
                        }
                    />
                </div>
            ),
            ...
            title: (
                <div>
                    ...
                    <Input
                        value={filters.price}
                        onChange={(e) =>
                            handleFilterChange({ ...filters, price: e.target.value })
                        }
                    />
                </div>
            ),
            ...
            title: (
                <div>
                    ...
                    <Input
                        ...
                        onChange={(e) =>
                            handleFilterChange({ ...filters, estate: e.target.value })
                        }
                    />
                </div>
            ),
            ...
            title: (
                <div>
                    ...
                    <Input
                        ...
                        onChange={(e) =>
                            handleFilterChange({ ...filters, stageName: e.target.value })
                        }
                    />
                </div>
            ),
            ...
            title: (
                <div>
                    ...
                    <Input
                        ...
                        onChange={(e) =>
                            handleFilterChange({ ...filters, address: e.target.value })
                        }
                    />
                </div>
            ),
        ...
        },
        {
            title: (
                <div>
                    <span>Status</span>
                    <StatusSelect value={filters.status} onChange={(value) =>
        ...
        },
        {
            title: (
                <div>
                    ...
                    <AssigneeSelect value={filters.createdby} onChange={(value) =>
                        handleFilterChange({ ...filters, createdby: value })} />
                </div>
            ),
            dataIndex: "createdby",
            key: "createdby",
            ...
            render: (_, record) => (
                <div className="flex justify-between items-center">
                    <Tooltip title={record.createdby} className="cursor-pointer"> <CustomAvtar label={record.createdby} /></Tooltip>
                    <div className="flex gap-4 text-blue items-center">
                        <Tooltip title="Copy Lot"><IconCopy size={15} onClick={() => {
                            setIsLotFormDrawerOpen(true)
                            setIsCopy(true)
                        }} className="cursor-pointer" /></Tooltip>
                        <Tooltip title="Packages"><IconTable size={15} onClick={() => setIsPackageDrawerOpen(true)} className="cursor-pointer" /></Tooltip>
                        <Tooltip title="Add Package"><IconPlus size={15} onClick={() => setIsNewPackageDrawerOpen(true)} className="cursor-pointer" /></Tooltip>
                    </div>
                </div>
            )
        },
    ...
    return (
        <div className="p-4">
            ...
            <LandCreatePackageDrawerModel title="New Package for 333" open={isNewPackageDrawerOpen} onClose={() => setIsNewPackageDrawerOpen(false)}
