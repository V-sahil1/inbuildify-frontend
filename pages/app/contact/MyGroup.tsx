...
export default function MyGroup() {
  const [createGroupSidebar, setCreateGroupSidebar] = useState<boolean>(false);
    ...
    <>
      <div className="flex items-center justify-between gap-4 flex-wrap mb-4">
        <h5 className="text-[20px]/[26px]">
          My Groups
          <span className="inline-block font-bold ms-1">(08)</span>
        </h5>
        ...
        <div className="card overflow-hidden bg-card-color rounded-xl relative md:p-6 p-4 flex flex-col border border-dashed border-border-color">
          ...
          <div className="py-6 flex gap-2 justify-center flex-wrap">
            <Image
              ...
              width="36"
              height="36"
              className="w-[36px] h-[36px] min-w-[36px] rounded-full bg-body-color flex items-center justify-center font-semibold text-secondary"
            />
            <Image
              src={avatar2}
              alt="user profile"
      ...
      >
        <div className="p-4 flex items-center justify-between gap-15">
          <div className="text-[20px]/[30px] font-medium">Create new Group</div>
        ...
        <div className="p-4 h-[calc(100svh-62px)] overflow-auto custom-scrollbar">
          ...
          <p className="mb-4">Contact List</p>
