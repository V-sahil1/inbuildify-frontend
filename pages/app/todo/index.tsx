    ...
    <div className="md:px-6 sm:px-3 pt-4">
      <div className="container-fluid">
        ...
        <div className="card border border-dashed border-border-color bg-card-color rounded-xl overflow-hidden">
          <div className="md:p-6 p-4">My Todo list</div>
          <div className="bg-body-color md:p-6 p-4">
            <div className="floating-form-control">
              ...
              />
              <label htmlFor="TodoInput1" className="form-label">
                What you need to do, sir?
              </label>
            </div>
            {error && (
              <div className="text-danger text-[14px]/[20px]">{error}</div>
            )}
          ...
          <ul className="md:px-6 px-4">
            {todoList.map((todo, index) => (
              <li
                key={index}
                className="py-4 flex items-center justify-between gap-2 border-b border-border-color last:border-none"
              >
                ...
                <button
                  className="bg-danger rounded-full text-white p-5"
