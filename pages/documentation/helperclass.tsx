...
import { IconLayout, IconPalette } from "@tabler/icons-react";
      ...
      <div className="md:px-6 sm:px-3 pt-4">
        <div className="container-fluid">
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="p-3 border-t border-border">
                      ...
                      <div>
                        Change attribute in html tage{" "}
                        <span className="text-danger">light, dark</span>
                      </div>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="p-3 border-t border-b border-border">
                      ...
                      <div>
                        Change attribute in html tage{" "}
                        <span className="text-danger">ltr, rtl</span>
                      </div>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="p-3 border-t border-b border-border">
                      ...
                      <div>
                        Change attribute in body tage{" "}
                        <span className="text-danger">
                          indigo, blue, cyan, green, orange, blush, red
                        </span>
                      </div>
                    </td>
                  </tr>
          ...
          <div className="card bg-card-color rounded-xl md:p-6 p-4">
            ...
            <div className="mb-30">
              <p className="text-[16px]/[24px] mb-10">Background Colors</p>
            ...
            <div className="mb-30">
              <p className="text-[16px]/[24px] mb-10">Action Colors</p>
              <div className="grid xxl:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-20">
            ...
            <div className="">
              <p className="text-[16px]/[24px] mb-10">Chart Colors</p>
              ...
              <p className="">Note : Chart color change as per theme</p>
            </div>
          </div>
        </div>
      </div>
