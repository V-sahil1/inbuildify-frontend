...
export default function Social() {
  const [socialSide, setSocialSide] = useState<boolean>(false);
   ...
   socialSide
     ...
     : "-left-full rtl:-right-full"
      ...
      >
        <Link
          href="#"
          className="mb-4 flex items-center gap-2 transition hover:text-secondary"
        >
          <Image
            src={profile_av}
            alt="profile"
            width="36"
            height="36"
            className="w-[36px] h-[36px] min-w-[36px] bg-white border border-border-color shadow-shadow-lg p-1 rounded-full saturate-50 transition-all hover:filter-none"
          />
          <span>Allie Grater</span>
        </Link>
        <TabList>
          <Tab
            className="flex items-center gap-4 py-2 px-3 border border-dashed border-transparent rounded-md font-semibold cursor-pointer hover:text-primary focus:outline-0"
        ...
        <ul className="flex flex-col gap-4">
          <li>
            ...
            >
              ...
              <span className="flex-1 inline-block">VueJS Developers</span>
            </Link>
          </li>
          <li>
            <Link
            ...
            >
              <IconTag className="w-[18px] h-[18px]" />
              <span className="flex-1 inline-block">Futurism</span>
            </Link>
          </li>
          <li>
            <Link
            ...
            >
              <IconTag className="w-[18px] h-[18px]" />
              <span className="flex-1 inline-block">Innovation</span>
            </Link>
          </li>
        </ul>
        <p className="py-4 mt-4 border-t border-border-color uppercase text-font-color-100 text-[14px]/[20px]">
        ...
        <ul className="flex flex-col gap-4">
          <li>
            ...
            >
              ...
              <span className="flex-1 inline-block">bigdata</span>
            </Link>
          </li>
          <li>
            <Link
            ...
            >
              <IconHash className="w-[18px] h-[18px]" />
              <span className="flex-1 inline-block">Design</span>
            </Link>
          </li>
          <li>
            <Link
            ...
            >
              <IconHash className="w-[18px] h-[18px]" />
              <span className="flex-1 inline-block">ReactJS</span>
            </Link>
          </li>
        </ul>
      </div>
