...
import { createFloorPlan, fetchFloorPlans, getFloorPlanFilters } from '@redux/feature/floorPlan/floorPlanThunk';
          ...
          <div className="card bg-card-color p-4 rounded-xl flex flex-col items-center border border-dashed border-border-color">
            ...
            <div className="flex w-full rounded-lg p-4 bg-white shadow-sm">
              ...
              <div className="flex-1 space-y-2 pl-4">
                <div className="flex justify-between">
                  <span className="font-medium">Dwelling:</span>
                ...
                <div className="flex justify-between">
                  <span className="font-medium">Porch:</span>
