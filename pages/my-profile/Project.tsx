  ...
  return (
    <>
      <div className="flex items-center justify-between gap-4 flex-wrap mb-4">
        <h5 className="text-[20px]/[24px] font-medium">My Projects</h5>
      ...
      <div className="flex flex-wrap gap-4">
        <div className="card bg-card-color rounded-xl xxl:flex-[1_0_calc(33.33%-32px)] sm:flex-[1_0_calc(50%-16px)] flex-grow border border-dashed border-border-color">
          <div className="md:p-6 p-4 border-b border-dashed border-border-color">
            ...
            <p className="text-font-color-100 mb-6">CRM App application to University Admin..</p>
            <ul className="flex gap-2 flex-wrap mb-6">
              <li className="py-1 px-4 border border-dashed border-border-color rounded-xl">
                <h6>7</h6>
                <small className="text-font-color-100 uppercase">Issues</small>
              </li>
              <li className="py-1 px-4 border border-dashed border-border-color rounded-xl">
                <h6>4</h6>
                <small className="text-font-color-100 uppercase">Resolved</small>
              </li>
              <li className="py-1 px-4 border border-dashed border-border-color rounded-xl">
                <h6>3</h6>
                <small className="text-font-color-100 uppercase">Comments</small>
              </li>
            </ul>
            <div className="flex items-center flex-wrap gap-1 mb-4">
              ...
              <Image
                ...
                width="26"
                height="26"
                className="w-[26px] h-[26px] min-w-[26px] rounded-full"
              />
              <Image
                src={avatar2}
                alt="user"
        ...
        <div className="card bg-card-color rounded-xl xxl:flex-[1_0_calc(33.33%-32px)] sm:flex-[1_0_calc(50%-16px)] flex-grow border border-dashed border-border-color">
          ...
          <div className="md:px-6 p-4 flex gap-x-3 gap-y-1 flex-wrap">
            <div className="flex gap-1 flex-wrap">
              <span className="min-w-fit">Due date :</span>
              <strong className="min-w-fit">21 May, 2022</strong>
            </div>
            <span className="inline-block">|</span>
            <div className="flex gap-1 flex-wrap">
              <span className="min-w-fit">Budget :</span>
              <strong className="min-w-fit">$22,050</strong>
            </div>
          </div>
        </div>
        <div className="card bg-card-color rounded-xl xxl:flex-[1_0_calc(33.33%-32px)] sm:flex-[1_0_calc(50%-16px)] flex-grow border border-dashed border-border-color">
          ...
          <div className="md:px-6 p-4 flex gap-x-3 gap-y-1 flex-wrap">
            <div className="flex gap-1 flex-wrap">
              <span className="min-w-fit">Due date :</span>
              <strong className="min-w-fit">21 Jun, 2022</strong>
            </div>
            <span className="inline-block">|</span>
            <div className="flex gap-1 flex-wrap">
              <span className="min-w-fit">Budget :</span>
              <strong className="min-w-fit">$1,12,050</strong>
            </div>
          </div>
        </div>
      </div>
