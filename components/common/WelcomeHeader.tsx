...
export default function WelcomeHeader({ report, income }: { report?: boolean; income?: boolean }) {
  ...
  return (
    <div className="flex md:items-center md:justify-between md:flex-row flex-col gap-15 mb-6">
      ...
      {report ? (
        <div className="form-control flex md:justify-end flex-1">
          <input
            type="text"
            id="dateRange"
            name="dateRange"
            className="form-input ssm:text-[14px]/[1] text-[12px]/[1] !py-2 !rounded-e-none w-full max-w-[300px]"
            defaultValue="04/12/2023 - 04/01/2024"
          />
          <button
            title="Send Report"
            className="py-2 px-3 bg-grey text-white transition-all hover:opacity-80"
          >
          ...
          <button
            ...
            className="py-2 px-3 bg-grey text-white transition-all hover:opacity-80 rounded-e-md"
          >
        ...
        <div className="flex">
          <div className="pe-4 border-e border-border-color">
            <div className="flex items-end gap-1 flex-wrap">
              <span className="md:text-[20px]/[26px] font-medium">8.18K</span>
          ...
          <div className="px-4 border-e border-border-color">
            <div className="flex items-end gap-1 flex-wrap">
              <span className="md:text-[20px]/[26px] font-medium">1.11K</span>
              <span className="text-[14px]/[20px] text-secondary flex items-end gap-1">
                <IconChevronUp className="w-[14px] h-[14px]" />
                4.1%
              </span>
          ...
          <div className="ps-4">
            <div className="flex items-end gap-1 flex-wrap">
              <span className="md:text-[20px]/[26px] font-medium">3.66K</span>
