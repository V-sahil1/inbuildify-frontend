        ...
        <div className="container-fluid">
          ...
          <div className="card bg-card-color rounded-xl md:p-6 p-4">
            <div className="flex gap-10 mb-30">
              <IconFolderFilled />
              <p className="text-[20px]/[24px] font-medium">File Structure</p>
            </div>
            <div>
              <ul>
                <li className="flex gap-5 mb-10 last:mb-0">
                  ...
                  <div>
                    <span className="text-danger">.next</span> ( NPM
                    dependencies (by default the folder is not included){" "}
                    <span className="text-danger">npm</span> installs
                    dependencies. )
                  </div>
                </li>
                <li className="flex gap-5 mb-10 last:mb-0">
                ...
                <li className="flex gap-5 mb-10 last:mb-0">
                  ...
                  <IconFolderFilled className="text-danger min-w-[20px] min-h-[20px] max-w-[20px] max-h-[20px]" />
                  <div>
                    <span className="text-danger">node_modules</span> ( NPM
                    dependencies (by default the folder is not included){" "}
                    <span className="text-danger">npm</span> installs
                    dependencies. )
                  </div>
