...
export default function Contact() {
  ...
  useEffect(() => {
    document.body.classList[addContactModal ? "add" : "remove"](
      "overflow-hidden"
    );
  }, [addContactModal]);
    ...
    <div className="md:px-6 sm:px-3 pt-4">
      <div className="container-fluid">
        ...
        <Tabs>
          <div className="card bg-card-color rounded-xl border border-dashed border-border-color">
            <div className="md:p-6 p-4 flex items-center gap-2 sm:justify-between justify-center border-b border-border-color">
              <div className="flex items-center gap-6 sm:flex-row flex-col">
                <Image
                  ...
                  width="90"
                  height="90"
                  className="w-[90px] h-[90px] min-w-[90px] object-cover rounded-xl"
                />
                <div className="sm:text-start text-center">
                  ...
                  <span className="text-danger text-[14px]/[20px]">
              ...
              <div className="items-center gap-6 sm:flex hidden">
                <button
                  ...
                  className="btn btn-primary md:!inline-flex !hidden"
                >
                  Add Contact
                </button>
                <div className="relative">
                  ...
                  >
                    <li>
                      <Link
                        href="#"
                        className="px-4 py-2 flex hover:bg-gray-100"
                      >
                        File Info
                      </Link>
                    </li>
            ...
            <TabList className="flex flex-wrap sm:px-6 px-2 pt-2 relative sm:justify-start justify-center">
              <Tab
                className="flex items-center gap-2 cursor-pointer py-2 sm:px-4 px-3 sm:text-base text-[14px]/[16px] border-b-[7px] border-transparent text-center -mb-1 transition-all hover:text-primary hover:border-primary focus:outline-0"
              ...
              >
                ...
                <span className="sm:block hidden">My Group</span>
              </Tab>
              <Tab
                className="flex items-center gap-2 cursor-pointer py-2 sm:px-4 px-3 sm:text-base text-[14px]/[16px] border-b-[7px] border-transparent text-center -mb-1 transition-all hover:text-primary hover:border-primary focus:outline-0"
                selectedClassName="!border-primary text-primary"
              >
                ...
                <span className="md:block hidden">Favorite</span>
              </Tab>
              <Tab
                className="flex items-center gap-2 cursor-pointer py-2 sm:px-4 px-3 sm:text-base text-[14px]/[16px] border-b-[7px] border-transparent text-center -mb-1 transition-all hover:text-primary hover:border-primary focus:outline-0"
                selectedClassName="!border-primary text-primary"
              >
                ...
                <span className="md:block hidden">Merge & Fix</span>
              </Tab>
              <Tab
                className="flex items-center gap-2 cursor-pointer py-2 sm:px-4 px-3 sm:text-base text-[14px]/[16px] border-b-[7px] border-transparent text-center -mb-1 transition-all hover:text-primary hover:border-primary focus:outline-0"
                selectedClassName="!border-primary text-primary"
              >
                ...
                <span className="sm:block hidden">Trash</span>
              </Tab>
            </TabList>
          </div>
          <div className="mt-6">
        ...
        {addContactModal && (
          <>
            <div
              className={`fixed p-15 w-full max-w-[650px] left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] z-[6]`}
            >
