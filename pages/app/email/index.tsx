          ...
          <div className="md:pb-6 pb-4 md:px-4 flex sm:items-center justify-between sm:flex-row flex-col gap-10">
            <div className="flex items-center gap-4 sm:justify-normal justify-between">
              ...
              <div className="flex items-stretch gap-5">
                <button
                  title="Refresh"
                  className="p-5 flex items-center gap-1 text-[14px]/[1] border border-grey rounded-md text-font-color transition-all hover:bg-grey hover:text-white"
                >
            ...
            <div className="flex items-center gap-4 sm:justify-normal justify-between">
              <span className="inline-block">1-50 of 234</span>
                ...
                <div className="grid xxl:grid-cols-[25%_auto] md:grid-cols-[33.33%_auto] grid-cols-1 md:gap-4 gap-2 flex-1">
                  ...
                  >
                    <Image
                      ...
                      width="32"
                      height="32"
                      className="w-[32px] h-[32px] min-w-[32px] rounded-md"
                    />
                ...
                <div className="grid xxl:grid-cols-[25%_auto] md:grid-cols-[33.33%_auto] grid-cols-1 md:gap-4 gap-2 flex-1">
                  ...
                  >
                    <Image
                      ...
                      className="w-[32px] h-[32px] min-w-[32px] rounded-md"
                    />
                    <span className="text-primary truncate">Brian Swader</span>
                  </Link>
                  <div className="">
                    <p>
                ...
                <div className="grid xxl:grid-cols-[25%_auto] md:grid-cols-[33.33%_auto] grid-cols-1 md:gap-4 gap-2 flex-1">
                  ...
                  >
                    <Image
                      ...
                      className="w-[32px] h-[32px] min-w-[32px] rounded-md"
                    />
                    <span className="text-primary truncate">Edit Toke</span>
                  </Link>
                  <div className="">
                    <p>
                ...
                <div className="grid xxl:grid-cols-[25%_auto] md:grid-cols-[33.33%_auto] grid-cols-1 md:gap-4 gap-2 flex-1">
                  ...
                  >
                    <Image
                      ...
                      className="w-[32px] h-[32px] min-w-[32px] rounded-md"
                    />
                    <span className="text-primary truncate">Dean Otto</span>
                  </Link>
                  <div className="">
                    <p>
                      The standard chunk of Lorem Ipsum used since the 1500s is
                ...
                <div className="grid xxl:grid-cols-[25%_auto] md:grid-cols-[33.33%_auto] grid-cols-1 md:gap-4 gap-2 flex-1">
                  ...
                  >
                    <Image
                      ...
                      className="w-[32px] h-[32px] min-w-[32px] rounded-md"
                    />
                    <span className="text-primary truncate">Jack Bird</span>
                  </Link>
                  <div className="">
                    <p>
                ...
                <div className="grid xxl:grid-cols-[25%_auto] md:grid-cols-[33.33%_auto] grid-cols-1 md:gap-4 gap-2 flex-1">
                  ...
                  >
                    <Image
                      ...
                      className="w-[32px] h-[32px] min-w-[32px] rounded-md"
                    />
                    <span className="text-primary truncate">Orlando Lentz</span>
                  </Link>
                  <div className="">
                    <p>
                      The standard chunk of Lorem Ipsum used since the 1500s is
                ...
                <div className="grid xxl:grid-cols-[25%_auto] md:grid-cols-[33.33%_auto] grid-cols-1 md:gap-4 gap-2 flex-1">
                  ...
                  >
                    <Image
                      ...
                      className="w-[32px] h-[32px] min-w-[32px] rounded-md"
                    />
                    <span className="text-primary truncate">Chris Fox</span>
                  </Link>
                  <div className="">
                    <p>
