                    ...
                    <div className='md:p-6 p-4'>
                        ...
                        <div className="flex gap-x-6 gap-y-2 flex-wrap">
                            <div className="form-check">
                                ...
                                <label htmlFor="findTicketAll" className="form-check-label !text-[16px]/[24px]">
                                    All
                                </label>
                            </div>
                            <div className="form-check">
                                <input type="checkbox" id="findNewTicket" className="form-check-input" />
                                <label htmlFor="findNewTicket" className="form-check-label !text-[16px]/[24px]">
                                    New Ticket
                                </label>
                            </div>
                            <div className="form-check">
                                <input type="checkbox" id="findInProgress" className="form-check-input" />
                                <label htmlFor="findInProgress" className="form-check-label !text-[16px]/[24px]">
                                    In Prograss
                                </label>
                            </div>
                            <div className="form-check">
                                <input type="checkbox" id="findOnHold" className="form-check-input" />
                                <label htmlFor="findOnHold" className="form-check-label !text-[16px]/[24px]">
                                    On Hold
                                </label>
                            </div>
                            <div className="form-check">
                                <input type="checkbox" id="findCompleted" className="form-check-input" />
                                <label htmlFor="findCompleted" className="form-check-label !text-[16px]/[24px]">
                                    Completed
                                </label>
                            </div>
                        </div>
