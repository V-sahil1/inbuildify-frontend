...
import { profileFields } from "@/components/formFields/proffileFields";
import { IconEdit } from "@tabler/icons-react";
import { updateUserThunk } from "@redux/feature/user/userThunk";
          ...
          <div className="md:p-6 p-4 border-b relative">
            ...
            <div className="flex md:items-start items-center md:gap-12 gap-4 md:flex-row flex-col">
              ...
              <div className="md:text-start text-center">
                ...
                <p>
                  Verification: {user?.isVerified ? "Completed" : "Pending"}
                </p>
              </div>
            </div>
          </div>
