            ...
            },
            {
                ...
                render: (supervisor: string, record: Maintenance) => {
                    ...
                    const handleMenuClick = (e: any) => {
                        const statusItem = ALL_MAINTENANCE_STATUSES.find(
                            (item) => item.key === e.key
                        );
                        if (statusItem) {
                            setSelectedStatus({
        ...
        <ConfirmationModal
            ...
            message={
                <div className="felx felx-col">
                    <p>Reverting this record will delete all information added after moved to construction. once deleted, you can't retrieve back the details.</p>
