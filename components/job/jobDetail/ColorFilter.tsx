...
import { IconArrowDown, IconBrandAppstore, IconGrid3x3, IconLayout2, IconLayoutDistributeHorizontal, IconSearch } from "@tabler/icons-react";
...
const ColorFilter: React.FC<ColorFilterProps> = (
    ...
    const menu = (
        <Menu
            onClick={({ key }) => onSupplierSelect && onSupplierSelect(key)}
            items={suppliers}
        />
    );
    return (
