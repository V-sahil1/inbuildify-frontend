...
export default function Setting() {
  return (
    <>
      <div className="text-[24px]/[30px] font-medium my-2">Setting</div>
      <div className="card bg-card-color rounded-xl md:p-6 p-4 border border-dashed border-border-color">
        ...
        <div className="grid md:grid-cols-[1fr_4fr] grid-cols-1 gap-2 form-control md:mb-4 sm:mb-6 mb-4">
          ...
          <div className="flex gap-6 flex-wrap">
            <div className="form-check">
              <input
                type="checkbox"
                id="projectSettingPhone"
                className="form-check-input"
              />
              <label
                htmlFor="projectSettingPhone"
            ...
            <div className="form-check">
              <input
                type="checkbox"
                id="projectSettingEmail"
                className="form-check-input"
                defaultChecked
              />
              <label
                htmlFor="projectSettingEmail"
                className="form-check-label !text-[16px]/[24px]"
              >
                Email
              </label>
        ...
        <div className="grid md:grid-cols-[1fr_4fr] grid-cols-1 gap-2 form-control md:mb-4 sm:mb-6 mb-4">
          ...
          <div className="form-check form-switch">
            <input
              type="checkbox"
              id="projectSettingStatus"
              className="form-check-input"
              defaultChecked
            />
            <label
              htmlFor="projectSettingStatus"
              className="form-check-label !text-[16px]/[24px]"
            >
              Active
            </label>
        ...
        <div className="flex items-stretch gap-5 justify-end border-t border-dashed border-border-color pt-6 mt-6">
          ...
          <button className="btn btn-primary large">Save Changes</button>
        </div>
      </div>
    </>
  );
