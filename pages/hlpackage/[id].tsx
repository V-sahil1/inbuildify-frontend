...
import { createHLPackageCommission, createHLPackagePricelist, createLandLot, deleteHLPackageCommission, deleteHLPackagPricelist, fetchAllHLPackageCommissionById, fetchAllHLPackagePricelistById, fetchAllLandPackageById, updateLandPackage } from '@redux/feature/land/landThunk';
            ...
            <div className="flex">
              <div className="flex-1">
                ...
                <ContentCard title="Lot">
                  <HLPackageLot deatils={deatils} editOpen={editOpen} setEditOpen={setEditOpen} setHasChanges={setHasChanges} lotOptions={lotOptions} lot={lot} setDeatils={setDeatils} />
                </ContentCard>
              </div>
              <div className="flex-1">
                <ContentCard title="Contact">
                  <HLPackageContact editOpen={editOpen} form={form} contactOptions={contactOptions} contact={contact} setEditOpen={setEditOpen} setHasChanges={setHasChanges} />
                </ContentCard>
                <ContentCard title="Price">
                  <HLPackagePrice setEditOpen={setEditOpen} packageDetails={packageDetails} form={form} setHasChanges={setHasChanges} />
                </ContentCard>
              </div>
            </div>
            <div>
              <div className="grid grid-cols-2 h-full">
                <ContentCard title="FloorPlan">
                  <HLPackageFloorPlan setEditOpen={setEditOpen} deatils={deatils} setDeatils={setDeatils} />
                </ContentCard>
                <ContentCard title="Facade">
                  <HLPackageFacade setEditOpen={setEditOpen} deatils={deatils} setDeatils={setDeatils} />
                </ContentCard>
              </div>
            </div>
          </div>
          <div className="grid grid-cols-2">
            <HLPackageInclusion editOpen={editOpen} setEditOpen={setEditOpen} form={form} filters={filters} setParams={setParams} activeTab={activeTab} setActiveTab={setActiveTab} />
