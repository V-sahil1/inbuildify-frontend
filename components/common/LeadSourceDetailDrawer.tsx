...
const LeadSourceDetailsDrawer = ({
    ...
    return (
        <Drawer
            ...
            bodyStyle={{ padding: 0 }}
            maskClosable={true}
            closeIcon={<div className="text-xl px-2 py-1 flex items-center justify-center rounded hover:text-primary"><IconX/></div>}
        ...
        >
            ...
            >
                <div className="grid grid-cols-2 gap-x-6 text-font-color font-medium">
                    ...
                    <Form.Item name="country" label={<div>Country</div>} initialValue="Australia" className="mb-4">
                    ...
                    <Form.Item name="state" label={<div>State / Region</div>} initialValue="Victoria" className="mb-4">
