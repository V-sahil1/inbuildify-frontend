    ...
    <>
      <div className="grid xxl:grid-cols-[5fr_7fr] grid-cols-1 gap-4 mb-6">
        <div className="grid sm:grid-cols-2 grid-cols-1 gap-4">
          <div className="card bg-card-color rounded-xl overflow-hidden border border-dashed border-border-color">
            <div className="md:p-6 p-4">
              <p className="uppercase mb-2">New Sessions</p>
              <p className="text-[24px]/[30px] font-medium mb-1">22,500</p>
              <p className="text-[14px]/[20px] text-font-color-100">Analytics for last week</p>
            </div>
            <ReactApexChart
          ...
          <div className="card bg-card-color rounded-xl overflow-hidden border border-dashed border-border-color">
            <div className="md:p-6 p-4">
              <p className="uppercase mb-2">TIME ON SITE</p>
              <p className="text-[24px]/[30px] font-medium mb-1">1,070</p>
              <p className="text-[14px]/[20px] text-font-color-100">Analytics for last week</p>
            </div>
            <ReactApexChart
          ...
          <div className="card bg-card-color rounded-xl overflow-hidden border border-dashed border-border-color">
            <div className="md:p-6 p-4">
              <p className="uppercase mb-2">BOUNCE RATE</p>
              <p className="text-[24px]/[30px] font-medium mb-1">10K</p>
              <p className="text-[14px]/[20px] text-font-color-100">Analytics for last week</p>
            </div>
            <ReactApexChart
          ...
          <div className="sm:col-span-2 flex gap-4 sm:flex-row flex-col-reverse card bg-secondary border border-dashed border-border-color text-white rounded-xl overflow-hidden md:p-6 p-4">
            <div>
              <p className="text-[20px]/[26px] font-medium mb-2">LUNO - Admin Dashboard Template</p>
        ...
        <div className="card bg-card-color rounded-xl border border-dashed border-border-color">
          <div className="flex items-center justify-between gap-15 md:p-6 p-4">
            <div>
              <div className="font-semibold">Impressions & Data Traffic</div>
          ...
          <div className="flex flex-wrap gap-2 md:p-6 p-4">
            <div className="flex-1 border border-dashed border-border-color py-2 px-4 rounded-xl">
              ...
              <div className="flex gap-1 items-end mb-2">
                <span className="md:text-[24px]/[30px] text-[20px]/[26px] font-bold">4.2M</span>
                <span className="text-success flex items-end">
                  <IconCornerRightUp />
                  43%
                </span>
              </div>
              <div className="text-font-color-100 text-[14px]/[20px]">5.0M Total Target</div>
            </div>
            <div className="flex-1 border border-dashed border-border-color py-2 px-4 rounded-xl">
              <div className="flex items-center gap-1 text-font-color-100 uppercase text-[14px]/[20px] mb-2">
              ...
              <div className="flex gap-1 items-end mb-2">
                <span className="md:text-[24px]/[30px] text-[20px]/[26px] font-bold">8.3M</span>
                <span className="text-danger flex items-end">
                  <IconCornerRightDown />
                  17%
                </span>
              </div>
              <div className="text-font-color-100 text-[14px]/[20px]">10.0M Total Target</div>
            </div>
            <div className="flex-1 border border-dashed border-border-color py-2 px-4 rounded-xl">
              <div className="text-font-color-100 uppercase text-[14px]/[20px] mb-2">DELEVERED</div>
      ...
      <div>
        <div className="flex items-center justify-between gap-4 flex-wrap mb-4">
          <div className="text-[20px]/[26px] font-medium">Recent Campaigns</div>
          <div className="flex items-stretch gap-1 flex-wrap">
            ...
            <button className="btn btn-outline-secondary !py-2 !px-3">
              ...
              <span className="sm:block hidden">Import</span>
            </button>
            <button className="btn btn-outline-secondary !py-2 !px-3">
        ...
        <div className="flex flex-col gap-5">
          <div className="card rounded-xl bg-card-color md:p-6 p-4 flex gap-4 lg:items-center lg:flex-row flex-col border border-dashed border-border-color">
            ...
            <div className="w-full lg:max-w-[600px]">
              <p className="font-medium">New Freebies for Designer and Developer</p>
              <p className="text-font-color-100">Regular (Send by time zone) 22 Dec 2021</p>
            </div>
            <div className="grid grid-cols-3 gap-2 w-full lg:max-w-[400px]">
              <div className="border border-dashed border-border-color py-2 sm:px-4 px-2 rounded-xl">
                <p className="font-medium">3,021</p>
                <p className="text-font-color-100 mb-1">Recipents</p>
              ...
              <div className="border border-dashed border-border-color py-2 sm:px-4 px-2 rounded-xl">
                ...
                <p className="text-font-color-100 mb-1">Opened</p>
                <div className="progress overflow-hidden h-[1px] bg-border-color rounded-full">
              ...
              <div className="border border-dashed border-border-color py-2 sm:px-4 px-2 rounded-xl">
                ...
                <p className="text-font-color-100 mb-1">Clicked</p>
                <div className="progress overflow-hidden h-[1px] bg-border-color rounded-full">
          ...
          <div className="card rounded-xl bg-card-color md:p-6 p-4 flex gap-4 lg:items-center lg:flex-row flex-col border border-dashed border-border-color">
            ...
            />
            <div className="w-full lg:max-w-[600px]">
              <p className="font-medium">Lucid - VueJS Admin Template & Webapp kit</p>
              <p className="text-font-color-100">Regular (Send by time zone) 25 Dec 2021</p>
            </div>
            <div className="grid grid-cols-3 gap-2 w-full lg:max-w-[400px]">
              <div className="border border-dashed border-border-color py-2 sm:px-4 px-2 rounded-xl">
                <p className="font-medium">5,201</p>
                <p className="text-font-color-100 mb-1">Recipents</p>
                <div className="progress overflow-hidden h-[1px] bg-border-color rounded-full">
                  <div className="progress-bar w-[77%] bg-primary h-full"></div>
                </div>
              ...
              <div className="border border-dashed border-border-color py-2 sm:px-4 px-2 rounded-xl">
                <p className="font-medium">16.5%</p>
                <p className="text-font-color-100 mb-1">Opened</p>
                <div className="progress overflow-hidden h-[1px] bg-border-color rounded-full">
                  <div className="progress-bar w-[91%] bg-secondary h-full"></div>
                </div>
          ...
          <div className="card rounded-xl bg-card-color md:p-6 p-4 flex gap-4 lg:items-center lg:flex-row flex-col border border-dashed border-border-color">
            ...
            />
            <div className="w-full lg:max-w-[600px]">
              <p className="font-medium">Alpino - Bootstrap 4 Admin Dashboard Template</p>
              <p className="text-font-color-100">Regular (Send by time zone) 26 Dec 2021</p>
            </div>
            <div className="grid grid-cols-3 gap-2 w-full lg:max-w-[400px]">
              <div className="border border-dashed border-border-color py-2 sm:px-4 px-2 rounded-xl">
                <p className="font-medium">3,548</p>
                <p className="text-font-color-100 mb-1">Recipents</p>
                <div className="progress overflow-hidden h-[1px] bg-border-color rounded-full">
                  <div className="progress-bar w-[77%] bg-primary h-full"></div>
                </div>
          ...
          <div className="card rounded-xl bg-card-color md:p-6 p-4 flex gap-4 lg:items-center lg:flex-row flex-col border border-dashed border-border-color">
            ...
            />
            <div className="w-full lg:max-w-[600px]">
              <p className="font-medium">New sale LUNO Admin template</p>
              <p className="text-font-color-100">Regular (Send by time zone) 31 Dec 2021</p>
            </div>
            <div className="grid grid-cols-3 gap-2 w-full lg:max-w-[400px]">
              <div className="border border-dashed border-border-color py-2 sm:px-4 px-2 rounded-xl">
      ...
      {campaignsModal && (
        <>
          ...
          >
            <div className="py-10 md:px-10 px-[7px] bg-card-color rounded-lg shadow-shadow-lg">
              <div className="my-10 lg:px-20 md:px-10 px-[7px] md:max-h-[80svh] max-h-[60svh] overflow-auto custom-scrollbar">
                <div className="text-[24px]/[30px] font-medium mb-2">Create Campaigns</div>
                  ...
                  <div className="relative w-full flex">
                    <div className="flex items-center justify-center gap-4 border border-border-color rounded-s-md me-[-1px] py-[6px] px-[12px] bg-body-color">
                      <div className="form-radio">
                        ...
                        />
                        <label className="form-radio-label" htmlFor="campaignsEmail">
                          Email
                        </label>
                      </div>
                      <div className="form-radio">
                        <input
                          ...
                          className="form-radio-input"
                        />
                        <label className="form-radio-label" htmlFor="campaignsStack">
                          Stack
                        </label>
                      </div>
                    </div>
          ...
          <div
            ...
            className={`fixed z-[5] w-full h-full left-0 top-0 bg-black-50 backdrop-blur-[2px]`}
          ></div>
        </>
      )}
    </>
