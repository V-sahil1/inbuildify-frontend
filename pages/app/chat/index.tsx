...
export default function Chat() {
  const [chatSide, setChatSide] = useState<boolean>(false);
  const chatSideToggle = () => {
    setChatSide(!chatSide);
  };

  const [chatVideoModal, setChatVideoModal] = useState<boolean>(false);
  const openChatVideoModal = () => {
    setChatVideoModal(!chatVideoModal);
  };
  useEffect(() => {
    document.body.classList[chatVideoModal ? "add" : "remove"](
      "overflow-hidden"
    );
  }, [chatVideoModal]);
  ...
  return (
    <>
      <div className="flex">
        <div
          className={`bg-card-color sm:min-w-[320px] ms-[2px] mt-[2px] sm:w-[320px] min-w-[280px] w-[280px] lg:static fixed z-[1] transition-all duration-300 ${
            chatSide
            ...
            <Tabs>
              <div className="p-4 border-b border-border-color">
                <TabList className="flex items-center p-[3px] border border-primary rounded-md">
                  <Tab
                    className="flex-1 py-5 px-4 text-center cursor-pointer text-primary rounded-md sm:text-[16px]/[24px] text-[14px]/[20px] focus:outline-0"
              ...
              <div className="xl:h-[calc(100svh-77px-52px-75px)] md:h-[calc(100svh-73px-52px-75px)] h-[calc(100svh-60px-52px-75px)] overflow-auto custom-scrollbar">
                <TabPanel>
                  <ul>
                    ...
                    <li className="border-b border-dashed border-border-color p-4 flex items-start gap-4 cursor-pointer transition-all hover:bg-body-color">
                      ...
                      <div className="truncate w-full">
                        <div className="flex items-center gap-2 justify-between">
                          <p className="truncate">Robert Hammer</p>
                          <span className="text-[11px]/[13px] text-font-color-100">
                            10:45 AM
                          </span>
                        </div>
                    ...
                    <li className="border-b border-dashed border-border-color p-4 flex items-start gap-4 cursor-pointer transition-all hover:bg-body-color">
                      ...
                      <div className="truncate w-full">
                        <div className="flex items-center gap-2 justify-between">
                          <p className="truncate">Orlando Lentz</p>
                          <span className="text-[11px]/[13px] text-font-color-100">
                            10:11 AM
                          </span>
                        </div>
                    ...
                    <li className="border-b border-dashed border-border-color p-4 flex items-start gap-4 cursor-pointer transition-all hover:bg-body-color">
                      ...
                      <div className="truncate w-full">
                        <div className="flex items-center gap-2 justify-between">
                          <p className="truncate">Barbara Kelly</p>
                          <span className="text-[11px]/[13px] text-font-color-100">
                            Sat
                          </span>
                        </div>
                    ...
                    <li className="border-b border-dashed border-border-color p-4 flex items-start gap-4 cursor-pointer transition-all hover:bg-body-color">
                      ...
                      <div className="truncate w-full">
                        <div className="flex items-center gap-2 justify-between">
                          <p className="truncate">Rose Rivera</p>
                          <span className="text-[11px]/[13px] text-font-color-100">
                            Thu
                          </span>
                        </div>
                ...
                <TabPanel>
                  <ul>
                    <li className="border-b border-dashed border-border-color p-4 flex items-start gap-4 cursor-pointer transition-all hover:bg-body-color">
                      ...
                      <div className="truncate w-full">
                        <div className="flex items-center gap-2 justify-between">
                          <p className="truncate">Design UI</p>
                          <span className="text-[11px]/[13px] text-font-color-100">
                            10:45 AM
                          </span>
                        </div>
                    ...
                    <li className="border-b border-dashed border-border-color p-4 flex items-start gap-4 cursor-pointer transition-all hover:bg-body-color">
                      ...
                      <div className="truncate w-full">
                        <div className="flex items-center gap-2 justify-between">
                          <p className="truncate">Angular Dev Team</p>
                          <span className="text-[11px]/[13px] text-font-color-100">
                            24/04/2024
                          </span>
                        </div>
                    ...
                    <li className="p-4 flex items-start gap-4 cursor-pointer transition-all hover:bg-body-color">
                      ...
                      <div className="truncate w-full">
                        <div className="flex items-center gap-2 justify-between">
                          <p className="truncate">Account Team</p>
                          <span className="text-[11px]/[13px] text-font-color-100">
                            20/01/2024
                          </span>
                        </div>
                ...
                <TabPanel>
                  ...
                  <li className="border-b border-dashed border-border-color p-4 flex items-start gap-4 cursor-pointer transition-all hover:bg-body-color">
                    ...
                    <div className="truncate w-full">
                      <div className="flex items-center gap-2 justify-between">
                        <p className="truncate">Richard Foos</p>
                        <div className="text-font-color-100 flex gap-2">
                          <button>
                            <IconHeart className="w-[20px] h-[20px]" />
                          </button>
                  ...
                  <li className="border-b border-dashed border-border-color p-4 flex items-start gap-4 cursor-pointer transition-all hover:bg-body-color">
                    ...
                    <div className="truncate w-full">
                      <div className="flex items-center gap-2 justify-between">
                        <p className="truncate">Frank Camly</p>
                        <div className="text-font-color-100 flex gap-2">
                          <button>
                            <IconHeart className="w-[20px] h-[20px]" />
                          </button>
                  ...
                  <li className="border-b border-dashed border-border-color p-4 flex items-start gap-4 cursor-pointer transition-all hover:bg-body-color">
                    ...
                    <div className="truncate w-full">
                      <div className="flex items-center gap-2 justify-between">
                        <p className="truncate">Brian Swader</p>
                        <div className="text-font-color-100 flex gap-2">
                          <button>
                            <IconHeart className="w-[20px] h-[20px]" />
                          </button>
        ...
        <div className="flex-1">
          <div className="border-b border-dashed border-border-color py-4 xxl:px-12 px-4 flex items-center gap-2 justify-between">
            ...
            <div className="flex gap-2 items-center">
              ...
              <button
                onClick={openChatVideoModal}
                className="lg:block hidden p-5 text-font-color-100 transition-all hover:text-blue"
              >
              ...
              <div className="max-w-[70%]">
                <div className="mb-2 flex gap-1">
                  <Image
                    ...
                    height="16"
                    alt="chat profile"
                    className="w-[16px] h-[16px] min-w-[16px] rounded-full"
                  />
          ...
          <div className="py-4 xxl:px-12 px-4 flex items-center border-t border-dashed border-border-color">
            ...
            <div className="relative flex-1 pr-4">
              <input
                ...
                className="w-full py-[6px] px-[12px] bg-transparent focus:outline-0 focus:text-primary"
              />
            </div>
      ...
      {chatVideoModal && (
        <>
          <div
            className={`fixed p-15 w-full md:max-w-[800px] max-w-[500px] left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] z-[6]`}
          >
            <div className="bg-card-color rounded-lg shadow-shadow-lg">
              <div className="sm:p-4 p-2 relative">
                ...
                <div className="sm:p-2 p-1 shadow-shadow-normal sm:rounded-xl rounded-md inline-block sm:mt-6 sm:me-6 mt-4 me-4 absolute end-0 top-0 bg-card-color">
                  <Image
                    ...
                    width="160"
                    height="160"
                    className="md:w-auto sm:w-100 w-50"
                  />
                </div>
              </div>
              <div className="sm:p-4 p-2 border-t border-border-color flex items-stretch justify-between flex-wrap sm:gap-4 gap-2">
                <div className="border border-border-color rounded-md">
                  <button
                    title="Info"
                    className="py-2 md:px-3 px-2 border-r border-border-color text-grey rounded-l-md transition-all hover:bg-grey hover:text-white"
                  >
                    <IconInfoCircle className="w-[16px] h-[16px]" />
                  </button>
                  <button
                    title="Comments"
                    className="py-2 md:px-3 px-2 border-r border-border-color text-grey transition-all hover:bg-grey hover:text-white"
                  >
                    <IconMessages className="w-[16px] h-[16px]" />
                  </button>
                  <button
                    title="Add User"
                    className="py-2 md:px-3 px-2 text-grey rounded-r-md transition-all hover:bg-grey hover:text-white"
                  >
                ...
                <div className="border border-border-color rounded-md">
                  ...
                  <button
                    onClick={openChatVideoModal}
                    title="Call End"
                    className="py-2 md:px-3 px-2 border-r border-border-color bg-danger text-white transition-all hover:opacity-80"
                  >
