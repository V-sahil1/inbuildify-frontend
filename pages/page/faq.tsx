    ...
    <Item
      ...
      header={({ state: { isEnter } }) => (
        <>
          {header}
          <IconChevronDown
            className={`w-[20px] h-[20px] min-w-[20px] transition-transform duration-200 ease-out ${
              isEnter && "rotate-180"
            }`}
          />
        </>
      ...
      buttonProps={{
        className:
          "text-left w-full flex items-center justify-between gap-4 md:p-6 p-4",
      }}
      contentProps={{
      ...
      <div className="container-fluid">
        ...
        <div className="grid md:grid-cols-[3fr_1fr] grid-cols-1 gap-6 items-start">
          <div>
            ...
            >
              <AccordionItem
                header="What is the Genesis Simple FAQ plugin?"
                initialEntered
              >
                <p className="mb-4">
            ...
            <div className="card rounded-xl bg-card-color md:p-6 p-4 border border-dashed border-border-color">
              ...
              <button className="btn btn-outline-primary">Send Support</button>
            </div>
          </div>
