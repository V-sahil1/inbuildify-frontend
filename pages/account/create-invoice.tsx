...
const SectionToPrint = React.forwardRef<HTMLDivElement, any>((props, ref) => (
  <div
    ref={ref}
    {...props}
    className="print-invoice card bg-card-color rounded-xl border border-dashed border-border-color"
  >
    <h5 className="md:p-6 p-4 text-[20px]/[24px] font-semibold border-b border-border-color">
      INVOICE
    </h5>
    <div className="md:p-6 md:m-6 p-3 m-3 border border-dashed border-border-color rounded-xl">
      <div className="flex gap-4 justify-between items-start sm:flex-row flex-col-reverse pb-6 mb-6 border-b border-border-color">
        ...
        <div className="relative inline-block">
          <Image
            ...
            width="120"
            height="120"
            className="sm:w-[120px] sm:h-[120px] sm:min-w-[120px] w-[80px] h-[80px] min-w-[80px] object-contain sm:rounded-xl rounded-md"
          />
        </div>
      </div>
      <div className="flex gap-4 justify-between items-start flex-wrap pb-6">
        <textarea
          cols={25}
          className="resize-none p-3 text-[20px]/[30px] font-bold"
          defaultValue={`Widget Card. c/o List\nWidget`}
        />
          ...
          <table className="border-t border-l border-border-color min-w-[300px]">
            <tbody>
              <tr>
                ...
                <td
                  align="right"
                  className="border-r border-b border-border-color p-2"
                >
                  <textarea
                    rows={1}
                    className="resize-none flex text-right print:p-0"
                    defaultValue="000123"
                  />
                </td>
              </tr>
        ...
        <table className="w-full border-t border-l border-border-color min-w-[700px]">
          <thead>
            <tr>
              <th
                align="left"
                className="bg-body-color p-2 border-r border-b border-border-color"
              >
                Item
              </th>
              <th
          ...
          <tbody>
            ...
            <tr className="print:hidden">
              <td
                ...
                className="border-r border-b border-border-color p-2"
              >
                <button className="text-primary transition-all hover:text-secondary">
                  Add a row
                </button>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td
                colSpan={2}
                align="right"
                className="border-r border-b border-border-color p-2 bg-body-color"
              >
                Balance Due
              </td>
              <td className="border-r border-b border-border-color p-2 bg-body-color">
      ...
      <div className="mt-12">
        ...
        <textarea
          className="resize-none flex bg-body-color p-2 w-full print:p-0"
          defaultValue="NET 30 Days. Finance Charge of 1.5% will be made on unpaid balances after 30 days."
        />
      </div>
    </div>
  </div>
