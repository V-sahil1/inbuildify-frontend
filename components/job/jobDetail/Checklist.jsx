    ...
    return (
        <div className="border-b-2 border-border-color p-3">
            ...
            <div className="flex gap-2 items-center" onClick={() => setNotesOpen(true)}>
                <div className="rounded-full text-sm w-4 h-4  text-white bg-primary flex items-center justify-center"> <IconPlus size={15} /> </div>
                <div>Notes</div>
            ...
            {isNotesOpen &&
                <div className="bg-card-color p-3 ">
                    ...
                    <div className="flex gap-2 justify-end mt-6">
                        ...
                        <Button type="primary" onClick={handleNotesEdit}> OK</Button>
