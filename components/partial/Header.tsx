...
export default function Header({
  ...
  const [cardShadow, setCardShadow] = useState<NodeListOf<Element>>();
  useEffect(() => {
  ...
  const shadowToggle = () => {
    ...
    cardShadow?.forEach((card: Element) => {
  ...
  const [dynamicColorItem, setDynamicColorItem] = useState<ColorPickerOption[]>(
    [
      {
        color: "bg-primary",
        label: "Primary Color",
    ...
    <>
              ...
              <div className="bg-card-color text-font-color rounded-xl overflow-hidden md:w-[380px] w-[calc(100%-30px)] shadow-shadow-lg md:absolute fixed md:end-0 end-15 md:top-full top-[55px] origin-top-right rtl:origin-top-left z-[1] opacity-0 invisible scale-0 transition-all duration-300 group-hover:opacity-100 group-hover:visible group-hover:scale-100">
                ...
                <Tabs>
                  <TabList className="flex flex-wrap sm:px-6 px-4 border-b border-border-color relative">
                    <Tab
                      className="flex-1 cursor-pointer py-2 px-3 border-b-[7px] border-transparent text-center -mb-1 text-secondary rounded-t-md transition-all hover:bg-primary-10 hover:border-primary focus:outline-0"
                  ...
                  <div className="md:h-[calc(60svh-185px)] h-[calc(80svh-185px)] sm:p-6 p-4 overflow-auto custom-scrollbar">
                    <TabPanel>
                      <ul>
                        <li className="py-10 border-b border-border-color flex gap-4">
                          ...
                          <div className="w-full">
                            <div className="flex justify-between gap-10">
                              <div className="font-medium">Olive Tree</div>
                        ...
                        <li className="py-10 border-b border-border-color flex gap-4">
                          ...
                          <div className="w-full">
                            <div className="flex justify-between gap-10">
                              <div className="font-medium">Del Phineum</div>
                              <span className="text-[12px]/[1] text-font-color-100">
                                1HR
                              </span>
                            </div>
                        ...
                        <li className="py-10 border-b border-border-color flex gap-4">
                          ...
                          <div className="w-full">
                            <div className="flex justify-between gap-10">
                              <div className="font-medium">Rose Bush</div>
                              <span className="text-[12px]/[1] text-font-color-100">
                                2MIN
                              </span>
                            </div>
                            <div className="text-[14px]/[20px]">
                              ...
                              <span className="text-white text-center text-[12px]/[1] bg-success rounded-md py-[2px] px-[5px]">
                                Review
                              </span>
                            </div>
                          </div>
                        ...
                        <li className="py-10 border-b border-border-color flex gap-4">
                          ...
                          <div className="w-full">
                            <div className="flex justify-between gap-10">
                              <div className="font-medium">Pat Thettick</div>
                              <span className="text-[12px]/[1] text-font-color-100">
                                13MIN
                              </span>
                            </div>
                        ...
                        <li className="py-10 border-b border-border-color flex gap-4">
                          ...
                          <div className="w-full">
                            <div className="flex justify-between gap-10">
                              <div className="font-medium">Eileen Dover</div>
                              <span className="text-[12px]/[1] text-font-color-100">
                                1HR
                              </span>
                            </div>
                        ...
                        <li className="py-10 border-b border-border-color flex gap-4">
                          ...
                          <div className="w-full">
                            <div className="flex justify-between gap-10">
                              <div className="font-medium">Carmen Goh</div>
                              <span className="text-[12px]/[1] text-font-color-100">
                                1DAY
                              </span>
                            </div>
                            <div className="text-[14px]/[20px]">
                              ...
                              <span className="text-white text-center text-[12px]/[1] bg-danger rounded-md py-[2px] px-[5px]">
                                Code
                              </span>
                            </div>
                          </div>
                        ...
                        <li className="py-10 border-b border-border-color flex gap-4">
                          ...
                          <div className="w-full">
                            <div className="flex justify-between gap-10">
                              <div className="font-medium">Karen Onnabit</div>
                              <span className="text-[12px]/[1] text-font-color-100">
                                1DAY
                              </span>
                            </div>
                    ...
                    <TabPanel>
                      <div className="text-font-color-400 text-[24px]/[30px] font-medium">
                        No Logs right now!
                      </div>
                    </TabPanel>
                  </div>
                ...
                <Link
                  href="#"
                  className="bg-primary text-[14px]/[20px] text-white py-5 px-10 text-center w-full inline-block"
                >
                  ...
                  <li className="py-10 px-15 border-b border-dashed border-border-color transition-all hover:bg-primary-10">
                    <Link href="#" className="flex items-center gap-2">
                      <Image
                        ...
                        height="15"
                        alt="language"
                        className="w-[20px] h-[15px] min-w-[20px]"
                      />
                      UK English
                    </Link>
                  </li>
      ...
      >
        ...
        <div className="md:p-6 p-4 md:h-[calc(100svh-63px-67px)] h-[calc(100svh-55px-59px)] overflow-auto custom-scrollbar">
                  ...
                  <li key={index}>
                    ...
                    {item.displayColorPicker && (
                      <div className="absolute z-[2]">
                        <div
                          onClick={() => handleCloseDynamicColor(index)}
                          className="fixed top-0 right-0 bottom-0 left-0"
                        />
                        <ChromePicker
                          color={item.colorValue}
                          onChange={(newColor) =>
                            handleChangeDynamicColor(newColor, index)
                          }
                        />
                      </div>
                    )}
          ...
          <div>
            <div className="mb-5">More Setting</div>
            <ul>
              <li className="py-3 px-4 border-b border-dashed border-border-color hover:bg-primary-10">
                <div className="form-check form-switch">
                  ...
                  />
                  <label className="form-check-label" htmlFor="header_fix">
                    Page Header Fix
                  </label>
                </div>
              </li>
              ...
              <li className="py-3 px-4 hover:bg-primary-10">
                <div className="form-check form-switch">
                  <input
                    ...
                    className="form-check-input"
                  />
                  <label className="form-check-label" htmlFor="shadow_checkbox">
                    Card Box-Shadow
                  </label>
                </div>
              </li>
        ...
        <div className="md:px-6 px-4 md:py-4 py-3 flex items-center gap-10 border-t border-border-color">
          ...
          <button
            className="btn btn-white !border-border-color w-full"
            onClick={toggleThemeSetting}
          >
            Close
          </button>
