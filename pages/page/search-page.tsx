...
export default function SearchPage() {
  ...
  useEffect(() => {
    document.body.classList[searchVideoModal ? "add" : "remove"](
      "overflow-hidden"
    );
  }, [searchVideoModal]);
  ...
  const galleryPhotos = [
    {
      ...
      content:
        "Some quick example text to build on the card title of the card's content.",
    },
    {
      image: gallery2,
      title: "Images card title",
        ...
        <Tabs>
          <div className="card bg-card-color rounded-xl border border-dashed border-border-color">
            ...
            <TabList className="flex flex-wrap md:px-6 px-4 pt-2 gap-y-2 relative justify-start border-t border-border-color">
              <Tab
                className="flex items-center gap-2 cursor-pointer py-2 md:px-4 px-3 md:text-base text-[14px]/[16px] border-b-[7px] border-transparent text-center -mb-1 transition-all hover:text-primary hover:border-primary focus:outline-0"
          ...
          <div className="card my-6 md:p-6 p-4 bg-card-color rounded-xl border border-dashed border-border-color">
            <TabPanel>
              <ul>
                <li className="md:pb-6 pb-4 md:mb-6 mb-4 border-b border-border-color last:mb-0">
                  <p className="mb-1">https://alui.luno-edu.com/index.html</p>
                  <Link
                    href="#"
                    className="mb-2 inline-block md:text-[20px]/[24px] text-[18px]/[22px] font-light text-primary transition-all hover:text-secondary"
                  >
                    LUNO - Bootstrap 5 Responsive Admin Dashboard Theme
                  </Link>
                  <p className="text-font-color-100 mb-4">
                    Boost your project with powerful LUNO admin dashboard
                    template that is tailored to fit every company's needs.
                  </p>
                  <div className="flex items-center flex-wrap md:gap-x-6 gap-x-4 text-font-color-100">
                    ...
                    <div>25,292 votes</div>
                    <div>React/Vue/Angular</div>
                  </div>
                </li>
                <li className="md:pb-6 pb-4 md:mb-6 mb-4 border-b border-border-color last:mb-0">
                  <p className="mb-1">https://luno-edu.info/</p>
                  <Link
                    href="#"
                    className="mb-2 inline-block md:text-[20px]/[24px] text-[18px]/[22px] font-light text-primary transition-all hover:text-secondary"
                  >
                  ...
                  <p className="text-font-color-100 mb-4">
                    LUNO introduces a IELTS Coaching, TOEFL Coaching, GRE
                    Coaching, GMAT Coaching, SAT Coaching in City.
                  </p>
                  <div className="flex items-center flex-wrap md:gap-x-6 gap-x-4 text-font-color-100">
                    <div className="flex items-center gap-1">
                      <IconStarFilled className="w-[16px] h-[16px] fill-warning" />
                ...
                <li className="md:pb-6 pb-4 md:mb-6 mb-4 border-b border-border-color last:mb-0">
                  ...
                  <Link
                    ...
                    className="mb-2 inline-block md:text-[20px]/[24px] text-[18px]/[22px] font-light text-primary transition-all hover:text-secondary"
                  >
                    Lucid - HR and Project Management Admin Dashboard Template
                    Bootstrap 5 & 4
                  </Link>
                  <p className="text-font-color-100 mb-4">
                    LUNO introduces a IELTS Coaching, TOEFL Coaching, GRE
            ...
            <TabPanel>
              ...
              <div
                ...
                // }}
                className="grid xxl:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-4"
              >
                {galleryPhotos.map((item, key) => (
                  <div
                    key={key}
                    className="border border-dashed border-border-color rounded-xl"
                  >
                    <Image
                      src={item.image}
                      data-lightboxjs="searchImage"
            ...
            <TabPanel>
              <div className="grid sm:grid-cols-3 ssm:grid-cols-2 gap-4">
                {galleryVideos.map((item, key) => (
                  <div
                    key={key}
                    className="rounded-xl overflow-hidden relative group after:absolute after:left-0 after:top-0 after:w-full after:h-full after:bg-black-50 after:hidden hover:after:block"
                  >
                    <Link
                      href="#"
                      onClick={openSearchVideoModal}
                      className="w-[48px] h-[48px] min-w-[48px] rounded-full bg-primary items-center justify-center text-white z-[1] absolute left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] transition-all hover:bg-secondary hidden group-hover:inline-flex"
                    >
                      <IconPlayerPlayFilled />
                    </Link>
                ...
                <div className="py-10 md:px-10 px-[7px] ">
                  <div className="my-10 lg:px-20 md:px-10 px-[7px] md:max-h-[80svh] max-h-[60svh] overflow-auto custom-scrollbar">
                    <iframe
                      ...
                      src="https://www.youtube.com/embed/9_PV-f87xPw"
                      frameBorder={0}
