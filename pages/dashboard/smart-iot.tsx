    ...
    <div className="md:px-6 sm:px-3 pt-4">
      <div className="container-fluid">
        ...
        <div className="grid xxl:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-4 mb-4">
          ...
          <div className="card md:p-6 p-4 rounded-xl bg-card-color border border-dashed border-border-color">
            <IconInfoSquare />
            <p className="mb-4">Problem devices</p>
            <span className="inline-block text-[24px]/[30px] font-medium">
              07
            </span>
          </div>
          <div className="card md:p-6 p-4 rounded-xl bg-card-color border border-dashed border-border-color">
            <IconProgressAlert />
            <p className="mb-4">24x7 Check problems</p>
            <span className="inline-block text-[24px]/[30px] font-medium">
              03
            </span>
          </div>
          <div className="card md:p-6 p-4 rounded-xl bg-card-color border border-dashed border-border-color">
            <IconBattery3 />
            <p className="mb-8">Power Backup</p>
        ...
        <div className="grid xxl:grid-cols-4 grid-cols-1 gap-4">
          <div className="grid xxl:grid-cols-3 grid-cols-1 gap-4 xxl:col-span-3">
            ...
            <div className="card md:p-6 p-4 rounded-xl border border-dashed border-info text-info bg-cyan-50">
              <IconFridge />
              <div className="mt-4">
                <p className="mb-2 font-medium">Refrigerator</p>
                <div className="flex items-center justify-between gap-15 text-[14px]/[20px]">
                  <span className="inline-block">Temprature :</span>
                  <span className="inline-block font-semibold">10° C</span>
                </div>
                <div className="flex items-center justify-between gap-15 text-[14px]/[20px]">
                  <span className="inline-block">Status :</span>
                  <span className="inline-block font-semibold">Stand By</span>
                </div>
              </div>
            </div>
            <div className="card md:p-6 p-4 rounded-xl border border-dashed border-grey text-grey bg-slate-100">
              <IconWashMachine />
              <div className="mt-4">
                <p className="mb-2 font-medium">Washing Machine</p>
                <div className="flex items-center justify-between gap-15 text-[14px]/[20px]">
                  <span className="inline-block">Remaining Time :</span>
                  <span className="inline-block font-semibold">01:23</span>
                </div>
                <div className="flex items-center justify-between gap-15 text-[14px]/[20px]">
                  <span className="inline-block">Status :</span>
                  <span className="inline-block font-semibold">On</span>
                </div>
              </div>
            </div>
            <div className="card rounded-xl bg-card-color xxl:col-span-3 border border-dashed border-border-color">
              <div className="flex items-center justify-between flex-wrap gap-15 md:p-6 p-4">
                <div className="font-semibold">Uses of Energy</div>
          ...
          <div className="card md:p-6 p-4 rounded-xl bg-card-color border border-dashed border-border-color">
            <p className="text-[20px]/[26px] font-medium mb-6">Quick Access</p>
            <div className="flex xxl:flex-col md:flex-row flex-col xxl:gap-6 md:gap-100 gap-6">
              <div>
                ...
                <div className="form-check form-switch mt-2">
                  ...
                  />
                  <label className="form-check-label" htmlFor="lightIndoor1">
                    Kitchen
                  </label>
                </div>
                <div className="form-check form-switch mt-2">
                  <input
                    ...
                    className="form-check-input"
                  />
                  <label className="form-check-label" htmlFor="lightIndoor2">
                    Dining Room
                  </label>
                </div>
                <div className="form-check form-switch mt-2">
                  <input
                    ...
                    defaultChecked
                  />
                  <label className="form-check-label" htmlFor="lightIndoor3">
                    Living Room
                  </label>
                </div>
                <div className="form-check form-switch mt-2">
                  <input
                    ...
                    className="form-check-input"
                  />
                  <label className="form-check-label" htmlFor="lightIndoor4">
                    Bed Room
                  </label>
                </div>
              </div>
              <div>
                ...
                <div className="form-check form-switch mt-2">
                  <input
                    ...
                    className="form-check-input"
                  />
                  <label className="form-check-label" htmlFor="lightOutdoor1">
                    Front Door
                  </label>
                </div>
                <div className="form-check form-switch mt-2">
                  <input
                    ...
                    className="form-check-input"
                  />
                  <label className="form-check-label" htmlFor="lightOutdoor2">
                    Back Door
                  </label>
                </div>
                <div className="form-check form-switch mt-2">
                  <input
                    ...
                    defaultChecked
                  />
                  <label className="form-check-label" htmlFor="lightOutdoor3">
                    Pool
                  </label>
                </div>
                <div className="form-check form-switch mt-2">
                  <input
                    ...
                    defaultChecked
                  />
                  <label className="form-check-label" htmlFor="lightOutdoor4">
                    Garage
                  </label>
                </div>
              </div>
              <div>
                ...
                <div className="form-check form-switch mt-2">
                  <input
                    ...
                    className="form-check-input"
                  />
                  <label className="form-check-label" htmlFor="lightOther2">
                    Sound System
                  </label>
                </div>
                <div className="form-check form-switch mt-2">
                  <input
                    ...
                    defaultChecked
                  />
                  <label className="form-check-label" htmlFor="lightOther3">
                    Air Conditioner
                  </label>
                </div>
                <div className="form-check form-switch mt-2">
                  <input
                    ...
                    defaultChecked
                  />
                  <label className="form-check-label" htmlFor="lightOther4">
                    Fridge
                  </label>
                </div>
                <div className="form-check form-switch mt-2">
                  <input
                    ...
                    className="form-check-input"
                  />
                  <label className="form-check-label" htmlFor="lightOther5">
                    Laptop
                  </label>
                </div>
                <div className="form-check form-switch mt-2">
