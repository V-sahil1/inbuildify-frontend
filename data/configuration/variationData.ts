export const variationSwitches = [
  {
  ...
  },
  {
    ...
    description:
      'If the toggle button is On - Mail will be sent once the variation is self approved',
  },
  {
    name: 'contractBasedVariationHeader',
    label: 'Contract-Based Variation Header',
    description:
      'When enabled, system shows Pre/Post contract header based on Signed Date. You can configure the labels below.',
  },
];
