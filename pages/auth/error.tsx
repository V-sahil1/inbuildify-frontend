...
export default function Custom() {
  return (
    <>
      ...
      <p className="md:text-[80px]/[90px] text-[60px]/[68px] font-medium mb-2 text-center">404</p>
      ...
      <p className="text-center sm:mb-12 mb-6 text-font-color-100">
        Sorry, the page you're looking for doesn;t exist. if you think something is brlken, report a
        problem.
      </p>
