            ...
            <TabPanel>
              <div className="border border-border-color rounded-xl p-6 relative mb-10">
                ...
                <div className="mb-6">
                  ...
                  <p>
                    ...
                    45 BC, making it over 2020 years old.
                  </p>
                </div>
              ...
              <div className="border border-border-color rounded-xl p-6 relative mb-10">
                ...
                <div className="mb-6">
                  ...
                  <div className="mb-4 text-[20px]/[30px]">Change a Design</div>
                  <p>
                ...
                <ul className="flex flex-col gap-4">
                  ...
                  <li className="flex flex-row-reverse items-end">
                    <div>
                      ...
                      <div className="p-3 rounded-lg bg-primary text-white">
                        <div className="message">
                          Yes, Orlando Allredy done There are many variations of
          ...
          <TabList className="flex items-center flex-col gap-2 sm:p-4 p-2">
            ...
            >
              <Image
                ...
                height="26"
                alt="chat profile"
                className="w-[26px] h-[26px] min-w-[26px] border border-body-color rounded-full saturate-50 hover:saturate-100"
              />
            </Tab>
            <Tab
              className="cursor-pointer p-1 rounded-full focus:outline-0"
