        ...
        <div className="bg-card-color p-2 ">
            <div className=" flex gap-4 p-3">
                <div className="rounded-xl flex gap-2 p-1 border border-primary">
                    <Button className={`rounded-xl text-xs ${activeTab === "Own" ? "bg-primary" : "bg-white text-primary"} `} type="primary" size="small" onClick={() => setActiveTab("Own")}>Own</Button>
                    <Button className={`rounded-xl text-xs ${activeTab === "All" ? "bg-primary" : "bg-white text-primary"} `} type="primary" size="small" onClick={() => setActiveTab("All")}>All</Button>
                </div>
                <div className="items-center flex w-full"><Input placeholder="Search by type,subject,sender & recipient email ID's" /></div>
                <div className="flex justify-end w-full text-primary"><IconFilter size={20} /></div>
            </div>
